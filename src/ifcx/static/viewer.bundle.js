...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Zn,depthTest:!1,depthWrite:!1})}function q0(i,t,e){let n=new Float32Array(ls),s=new L(0,1,0);return new Mn({name:"SphericalGaussianBlur",defines:{n:ls,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Il(),fragmentShader:`
		...
		`,blending:Zn,depthTest:!1,depthWrite:!1})}function ed(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Il(),fragmentShader:`
		...
		`,blending:Zn,depthTest:!1,depthWrite:!1})}function nd(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Il(),fragmentShader:`
	...
	`}var Rl=class extends vn{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;let n={width:t,height:t,depth:1},s=[n,n,n,n,n,n];this.texture=new Nr(s),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new ks(5,5,5),r=new Mn({name:"CubemapFromEquirect",uniforms:as(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Ge,blending:Zn});r.uniforms.tEquirect.value=e;let o=new ve(s,r),a=e.minFilter;return e.minFilter===Ni&&(e.minFilter=ke),new Ba(1,10,this).update(t,o),e.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(t,e=!0,n=!0,s=!0){let r=t.getRenderTarget();for(let o=0;o<6;o++)t.setRenderTarget(this,o),t.clear(e,n,s);t.setRenderTarget(r)}};function Y0(i){let t=new WeakMap,e=new WeakMap,n=null;function s(h,d=!1){return h==null?null:d?o(h):r(h)}function r(h){if(h&&h.isTexture){let d=h.mapping;if(d===za||d===Va)if(t.has(h)){let g=t.get(h).texture;return a(g,h.mapping)}else{let g=h.image;if(g&&g.height>0){let y=new Rl(g.height);return y.fromEquirectangularTexture(i,h),t.set(h,y),h.addEventListener("dispose",c),a(y.texture,h.mapping)}else return null}}return h}function o(h){if(h&&h.isTexture){let d=h.mapping,g=d===za||d===Va,y=d===Di||d===os;if(g||y){let m=e.get(h),p=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==p)return n===null&&(n=new Cl(i)),m=g?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,e.set(h,m),m.texture;if(m!==void 0)return m.texture;{let M=h.image;return g&&M&&M.height>0||y&&M&&l(M)?(n===null&&(n=new Cl(i)),m=g?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,e.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function a(h,d){return d===za?h.mapping=Di:d===Va&&(h.mapping=os),h}function l(h){let d=0,g=6;for(let y=0;y<g;y++)h[y]!==void 0&&d++;return d===g}function c(h){let d=h.target;d.removeEventListener("dispose",c);let g=t.get(d);g!==void 0&&(t.delete(d),g.dispose())}function u(h){let d=h.target;d.removeEventListener("dispose",u);let g=e.get(d);g!==void 0&&(e.delete(d),g.dispose())}function f(){t=new WeakMap,e=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:f}}function Z0(i){let t={};function e(n){if(t[n]!==void 0)return t[n];let s=i.getExtension(n);return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){let s=e(n);return s===null&&ts("WebGLRenderer: "+n+" extension not supported."),s}}}function $0(i,t,e,n){let s={},r=new WeakMap;function o(f){let h=f.target;h.index!==null&&t.remove(h.index);for(let g in h.attributes)t.remove(h.attributes[g]);h.removeEventListener("dispose",o),delete s[h.id];let d=r.get(h);d&&(t.remove(d),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,e.memory.geometries--}function a(f,h){return s[h.id]===!0||(h.addEventListener("dispose",o),s[h.id]=!0,e.memory.geometries++),h}function l(f){let h=f.attributes;for(let d in h)t.update(h[d],i.ARRAY_BUFFER)}function c(f){let h=[],d=f.index,g=f.attributes.position,y=0;if(g===void 0)return;if(d!==null){let M=d.array;y=d.version;for(let b=0,x=M.length;b<x;b+=3){let S=M[b+0],T=M[b+1],w=M[b+2];h.push(S,T,T,w,w,S)}}else{let M=g.array;y=g.version;for(let b=0,x=M.length/3-1;b<x;b+=3){let S=b+0,T=b+1,w=b+2;h.push(S,T,T,w,w,S)}}let m=new(g.count>=65535?Lr:Ir)(h,1);m.version=y;let p=r.get(f);p&&t.remove(p),r.set(f,m)}function u(f){let h=r.get(f);if(h){let d=f.index;d!==null&&h.version<d.version&&c(f)}else c(f);return r.get(f)}return{get:a,update:l,getWireframeAttribute:u}}function J0(i,t,e){let n;function s(f){n=f}let r,o;function a(f){r=f.type,o=f.bytesPerElement}function l(f,h){i.drawElements(n,h,r,f*o),e.update(h,n,1)}function c(f,h,d){d!==0&&(i.drawElementsInstanced(n,h,r,f*o,d),e.update(h,n,d))}function u(f,h,d){if(d===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,f,0,d);let y=0;for(let m=0;m<d;m++)y+=h[m];e.update(y,n,1)}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function K0(i){let t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:Pt("WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function j0(i,t,e){let n=new WeakMap,s=new me;function r(o,a,l){let c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=u!==void 0?u.length:0,h=n.get(a);if(h===void 0||h.count!==f){let A=function(){w.dispose(),n.delete(a),a.removeEventListener("dispose",A)};h!==void 0&&h.texture.dispose();let d=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,y=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],M=a.morphAttributes.color||[],b=0;d===!0&&(b=1),g===!0&&(b=2),y===!0&&(b=3);let x=a.attributes.position.count*b,S=1;x>t.maxTextureSize&&(S=Math.ceil(x/t.maxTextureSize),x=t.maxTextureSize);let T=new Float32Array(x*S*4*f),w=new Rr(T,x,S,f);w.type=xn,w.needsUpdate=!0;let _=b*4;for(let C=0;C<f;C++){let P=m[C],R=p[C],D=M[C],O=x*S*4*C;for(let N=0;N<P.count;N++){let H=N*_;d===!0&&(s.fromBufferAttribute(P,N),T[O+H+0]=s.x,T[O+H+1]=s.y,T[O+H+2]=s.z,T[O+H+3]=0),g===!0&&(s.fromBufferAttribute(R,N),T[O+H+4]=s.x,T[O+H+5]=s.y,T[O+H+6]=s.z,T[O+H+7]=0),y===!0&&(s.fromBufferAttribute(D,N),T[O+H+8]=s.x,T[O+H+9]=s.y,T[O+H+10]=s.z,T[O+H+11]=D.itemSize===4?s.w:1)}}h={count:f,texture:w,size:new Mt(x,S)},n.set(a,h),a.addEventListener("dispose",A)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let d=0;for(let y=0;y<c.length;y++)d+=c[y];let g=a.morphTargetsRelative?1:1-d;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function Q0(i,t,e,n,s){let r=new WeakMap;function o(c){let u=s.render.frame,f=c.geometry,h=t.get(c,f);if(r.get(h)!==u&&(t.update(h),r.set(h,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){let d=c.skeleton;r.get(d)!==u&&(d.update(),r.set(d,u))}return h}function a(){r=new WeakMap}function l(c){let u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),e.remove(u.instanceMatrix),u.instanceColor!==null&&e.remove(u.instanceColor)}return{update:o,dispose:a}}var tx={[ah]:"LINEAR_TONE_MAPPING",[lh]:"REINHARD_TONE_MAPPING",[ch]:"CINEON_TONE_MAPPING",[Zr]:"ACES_FILMIC_TONE_MAPPING",[uh]:"AGX_TONE_MAPPING",[fh]:"NEUTRAL_TONE_MAPPING",[hh]:"CUSTOM_TONE_MAPPING"};function ex(i,t,e,n,s,r){let o=new vn(t,e,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,depthTexture:s?new hi(t,e):void 0}),a=new vn(t,e,{type:$n,depthBuffer:!1,stencilBuffer:!1}),l=new Te;l.setAttribute("position",new Ve([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new Ve([0,2,0,0,2,0],2));let c=new Ta({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new ve(l,c),f=new Gs(-1,1,1,-1,0,1),h=null,d=null,g=!1,y,m=null,p=[],M=!1;this.setSize=function(b,x){o.setSize(b,x),a.setSize(b,x);for(let S=0;S<p.length;S++){let T=p[S];T.setSize&&T.setSize(b,x)}},this.setEffects=function(b){p=b,M=p.length>0&&p[0].isRenderPass===!0;let x=o.width,S=o.height;for(let T=0;T<p.length;T++){let w=p[T];w.setSize&&w.setSize(x,S)}},this.begin=function(b,x){if(g||b.toneMapping===Bn&&p.length===0)return!1;if(m=x,x!==null){let S=x.width,T=x.height;(o.width!==S||o.height!==T)&&this.setSize(S,T)}return M===!1&&b.setRenderTarget(o),y=b.toneMapping,b.toneMapping=Bn,!0},this.hasRenderPass=function(){return M},this.end=function(b,x){b.toneMapping=y,g=!0;let S=o,T=a;for(let w=0;w<p.length;w++){let _=p[w];if(_.enabled!==!1&&(_.render(b,T,S,x),_.needsSwap!==!1)){let A=S;S=T,T=A}}if(h!==b.outputColorSpace||d!==b.toneMapping){h=b.outputColorSpace,d=b.toneMapping,c.defines={},Gt.getTransfer(h)===Qt&&(c.defines.SRGB_TRANSFER="");let w=tx[d];w&&(c.defines[w]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=S.texture,b.setRenderTarget(m),b.render(u,f),m=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){o.depthTexture&&o.depthTexture.dispose(),o.dispose(),a.dispose(),l.dispose(),c.dispose()}}var Sd=new hn,Nh=new hi(1,1),bd=new Rr,Td=new xa,Ed=new Nr,id=[],sd=[],rd=new Float32Array(16),od=new Float32Array(9),ad=new Float32Array(4);function Ks(i,t,e){let n=i[0];if(n<=0||n>0)return i;let s=t*e,r=id[s];if(r===void 0&&(r=new Float32Array(s),id[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function Ie(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Le(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Ll(i,t){let e=sd[t];e===void 0&&(e=new Int32Array(t),sd[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function nx(i,t){let e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function ix(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ie(e,t))return;i.uniform2fv(this.addr,t),Le(e,t)}}function sx(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ie(e,t))return;i.uniform3fv(this.addr,t),Le(e,t)}}function rx(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ie(e,t))return;i.uniform4fv(this.addr,t),Le(e,t)}}function ox(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(Ie(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Le(e,t)}else{if(Ie(e,n))return;ad.set(n),i.uniformMatrix2fv(this.addr,!1,ad),Le(e,n)}}function ax(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(Ie(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Le(e,t)}else{if(Ie(e,n))return;od.set(n),i.uniformMatrix3fv(this.addr,!1,od),Le(e,n)}}function lx(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(Ie(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Le(e,t)}else{if(Ie(e,n))return;rd.set(n),i.uniformMatrix4fv(this.addr,!1,rd),Le(e,n)}}function cx(i,t){let e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function hx(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ie(e,t))return;i.uniform2iv(this.addr,t),Le(e,t)}}function ux(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ie(e,t))return;i.uniform3iv(this.addr,t),Le(e,t)}}function fx(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ie(e,t))return;i.uniform4iv(this.addr,t),Le(e,t)}}function dx(i,t){let e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function px(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ie(e,t))return;i.uniform2uiv(this.addr,t),Le(e,t)}}function mx(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ie(e,t))return;i.uniform3uiv(this.addr,t),Le(e,t)}}function gx(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ie(e,t))return;i.uniform4uiv(this.addr,t),Le(e,t)}}function _x(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Nh.compareFunction=e.isReversedDepthBuffer()?El:Tl,r=Nh):r=Sd,e.setTexture2D(t||r,s)}function xx(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Td,s)}function yx(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Ed,s)}function vx(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||bd,s)}function Mx(i){switch(i){case 5126:return nx;case 35664:return ix;case 35665:return sx;case 35666:return rx;case 35674:return ox;case 35675:return ax;case 35676:return lx;case 5124:case 35670:return cx;case 35667:case 35671:return hx;case 35668:case 35672:return ux;case 35669:case 35673:return fx;case 5125:return dx;case 36294:return px;case 36295:return mx;case 36296:return gx;case 35678:case 36198:case 36298:case 36306:case 35682:return _x;case 35679:case 36299:case 36307:return xx;case 35680:case 36300:case 36308:case 36293:return yx;case 36289:case 36303:case 36311:case 36292:return vx}}function Sx(i,t){i.uniform1fv(this.addr,t)}function bx(i,t){let e=Ks(t,this.size,2);i.uniform2fv(this.addr,e)}function Tx(i,t){let e=Ks(t,this.size,3);i.uniform3fv(this.addr,e)}function Ex(i,t){let e=Ks(t,this.size,4);i.uniform4fv(this.addr,e)}function Ax(i,t){let e=Ks(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function wx(i,t){let e=Ks(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Cx(i,t){let e=Ks(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Rx(i,t){i.uniform1iv(this.addr,t)}function Px(i,t){i.uniform2iv(this.addr,t)}function Ix(i,t){i.uniform3iv(this.addr,t)}function Lx(i,t){i.uniform4iv(this.addr,t)}function Dx(i,t){i.uniform1uiv(this.addr,t)}function Nx(i,t){i.uniform2uiv(this.addr,t)}function Ux(i,t){i.uniform3uiv(this.addr,t)}function Fx(i,t){i.uniform4uiv(this.addr,t)}function Bx(i,t,e){let n=this.cache,s=t.length,r=Ll(e,s);Ie(n,r)||(i.uniform1iv(this.addr,r),Le(n,r));let o;this.type===i.SAMPLER_2D_SHADOW?o=Nh:o=Sd;for(let a=0;a!==s;++a)e.setTexture2D(t[a]||o,r[a])}function Ox(i,t,e){let n=this.cache,s=t.length,r=Ll(e,s);Ie(n,r)||(i.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||Td,r[o])}function zx(i,t,e){let n=this.cache,s=t.length,r=Ll(e,s);Ie(n,r)||(i.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||Ed,r[o])}function Vx(i,t,e){let n=this.cache,s=t.length,r=Ll(e,s);Ie(n,r)||(i.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||bd,r[o])}function kx(i){switch(i){case 5126:return Sx;case 35664:return bx;case 35665:return Tx;case 35666:return Ex;case 35674:return Ax;case 35675:return wx;case 35676:return Cx;case 5124:case 35670:return Rx;case 35667:case 35671:return Px;case 35668:case 35672:return Ix;case 35669:case 35673:return Lx;case 5125:return Dx;case 36294:return Nx;case 36295:return Ux;case 36296:return Fx;case 35678:case 36198:case 36298:case 36306:case 35682:return Bx;case 35679:case 36299:case 36307:return Ox;case 35680:case 36300:case 36308:case 36293:return zx;case 36289:case 36303:case 36311:case 36292:return Vx}}var Uh=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Mx(e.type)}},Fh=class{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=kx(e.type)}},Bh=class{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){let s=this.seq;for(let r=0,o=s.length;r!==o;++r){let a=s[r];a.setValue(t,e[a.id],n)}}},Lh=/(\w+)(\])?(\[|\.)?/g;function ld(i,t){i.seq.push(t),i.map[t.id]=t}function Gx(i,t,e){let n=i.name,s=n.length;for(Lh.lastIndex=0;;){let r=Lh.exec(n),o=Lh.lastIndex,a=r[1],l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){ld(e,c===void 0?new Uh(a,i,t):new Fh(a,i,t));break}else{let f=e.map[a];f===void 0&&(f=new Bh(a),ld(e,f)),e=f}}}var $s=class{constructor(t,e){this.seq=[],this.map={};let n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let o=0;o<n;++o){let a=t.getActiveUniform(e,o),l=t.getUniformLocation(e,a.name);Gx(a,l,this)}let s=[],r=[];for(let o of this.seq)o.type===t.SAMPLER_2D_SHADOW||o.type===t.SAMPLER_CUBE_SHADOW||o.type===t.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(t,e,n,s){let r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){let s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){let a=e[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,s)}}static seqWithValue(t,e){let n=[];for(let s=0,r=t.length;s!==r;++s){let o=t[s];o.id in e&&n.push(o)}return n}};function cd(i,t,e){let n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}var Hx=37297,Wx=0;function Xx(i,t){let e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){let a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}var hd=new Lt;function qx(i){Gt._getMatrix(hd,Gt.workingColorSpace,i);let t=`mat3( ${hd.elements.map(e=>e.toFixed(4))} )`;switch(Gt.getTransfer(i)){case wr:return[t,"LinearTransferOETF"];case Qt:return[t,"sRGBTransferOETF"];default:return wt("WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function ud(i,t,e){let n=i.getShaderParameter(t,i.COMPILE_STATUS),r=(i.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";let o=/ERROR: 0:(\d+)/.exec(r);if(o){let a=parseInt(o[1]);return e.toUpperCase()+`

`+r+`

`+Xx(i.getShaderSource(t),a)}else return r}function Yx(i,t){let e=qx(t);return[`vec4 ${i}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}var Zx={[ah]:"Linear",[lh]:"Reinhard",[ch]:"Cineon",[Zr]:"ACESFilmic",[uh]:"AgX",[fh]:"Neutral",[hh]:"Custom"};function $x(i,t){let e=Zx[t];return e===void 0?(wt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var wl=new L;function Jx(){Gt.getLuminanceCoefficients(wl);let i=wl.x.toFixed(4),t=wl.y.toFixed(4),e=wl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Kx(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ao).join(`
`)}function jx(i){let t=[];for(let e in i){let n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Qx(i,t){let e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(t,s),o=r.name,a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function ao(i){return i!==""}function fd(i,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function dd(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var ty=/^[ \t]*#include +<([\w\d./]+)>/gm;function Oh(i){return i.replace(ty,ny)}var ey=new Map;function ny(i,t){let e=zt[t];if(e===void 0){let n=ey.get(t);if(n!==void 0)e=zt[n],wt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+t+">")}return Oh(e)}var iy=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function pd(i){return i.replace(iy,sy)}function sy(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function md(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}var ry={[Yr]:"SHADOWMAP_TYPE_PCF",[Ws]:"SHADOWMAP_TYPE_VSM"};function oy(i){return ry[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var ay={[Di]:"ENVMAP_TYPE_CUBE",[os]:"ENVMAP_TYPE_CUBE",[$r]:"ENVMAP_TYPE_CUBE_UV"};function ly(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":ay[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var cy={[os]:"ENVMAP_MODE_REFRACTION"};function hy(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":cy[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var uy={[oh]:"ENVMAP_BLENDING_MULTIPLY",[Nf]:"ENVMAP_BLENDING_MIX",[Uf]:"ENVMAP_BLENDING_ADD"};function fy(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":uy[i.combine]||"ENVMAP_BLENDING_NONE"}function dy(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function py(i,t,e,n){let s=i.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,l=oy(e),c=ly(e),u=hy(e),f=fy(e),h=dy(e),d=Kx(e),g=jx(r),y=s.createProgram(),m,p,M=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);let b=M+m+o,x=M+p+a,S=cd(s,s.VERTEX_SHADER,b),T=cd(s,s.FRAGMENT_SHADER,x);s.attachShader(y,S),s.attachShader(y,T),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function w(P){if(i.debug.checkShaderErrors){let R=s.getProgramInfoLog(y)||"",D=s.getShaderInfoLog(S)||"",O=s.getShaderInfoLog(T)||"",N=R.trim(),H=D.trim(),X=O.trim(),K=!0,tt=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,S,T);else{let rt=ud(s,S,"vertex"),ht=ud(s,T,"fragment");Pt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`,kh=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new Ur(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new Mn({vertexShader:Uy,fragmentShader:Fy,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new ve(new Br(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Gh=class extends Un{constructor(t,e){super();let n=this,s=null,r=1,o=null,a="local-floor",l=1,c=null,u=null,f=null,h=null,d=null,g=null,y=typeof XRWebGLBinding<"u",m=new kh,p={},M=e.getContextAttributes(),b=null,x=null,S=[],T=[],w=new Mt,_=null,A=new Je;A.viewport=new me;let C=new Je;C.viewport=new me;let P=[A,C],R=new Oa,D=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let it=S[$];return it===void 0&&(it=new Os,S[$]=it),it.getTargetRaySpace()},this.getControllerGrip=function($){let it=S[$];return it===void 0&&(it=new Os,S[$]=it),it.getGripSpace()},this.getHand=function($){let it=S[$];return it===void 0&&(it=new Os,S[$]=it),it.getHandSpace()};function N($){let it=T.indexOf($.inputSource);if(it===-1)return;let et=S[it];et!==void 0&&(et.update($.inputSource,$.frame,c||o),et.dispatchEvent({type:$.type,data:$.inputSource}))}function H(){s.removeEventListener("select",N),s.removeEventListener("selectstart",N),s.removeEventListener("selectend",N),s.removeEventListener("squeeze",N),s.removeEventListener("squeezestart",N),s.removeEventListener("squeezeend",N),s.removeEventListener("end",H),s.removeEventListener("inputsourceschange",X);for(let $=0;$<S.length;$++){let it=T[$];it!==null&&(T[$]=null,S[$].disconnect(it))}D=null,O=null,m.reset();for(let $ in p)delete p[$];t.setRenderTarget(b),d=null,h=null,f=null,s=null,x=null,kt.stop(),n.isPresenting=!1,t.setPixelRatio(_),t.setSize(w.width,w.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){r=$,n.isPresenting===!0&&wt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){a=$,n.isPresenting===!0&&wt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function($){c=$},this.getBaseLayer=function(){return h!==null?h:d},this.getBinding=function(){return f===null&&y&&(f=new XRWebGLBinding(s,e)),f},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function($){if(s=$,s!==null){if(b=t.getRenderTarget(),s.addEventListener("select",N),s.addEventListener("selectstart",N),s.addEventListener("selectend",N),s.addEventListener("squeeze",N),s.addEventListener("squeezestart",N),s.addEventListener("squeezeend",N),s.addEventListener("end",H),s.addEventListener("inputsourceschange",X),M.xrCompatible!==!0&&await e.makeXRCompatible(),_=t.getPixelRatio(),t.getSize(w),y&&"createProjectionLayer"in XRWebGLBinding.prototype){let et=null,It=null,Nt=null;M.depth&&(Nt=M.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,et=M.stencil?Ui:qn,It=M.stencil?qs:wn);let Ct={colorFormat:e.RGBA8,depthFormat:Nt,scaleFactor:r};f=this.getBinding(),h=f.createProjectionLayer(Ct),s.updateRenderState({layers:[h]}),t.setPixelRatio(1),t.setSize(h.textureWidth,h.textureHeight,!1),x=new vn(h.textureWidth,h.textureHeight,{format:cn,type:un,depthTexture:new hi(h.textureWidth,h.textureHeight,It,void 0,void 0,void 0,void 0,void 0,void 0,et),stencilBuffer:M.stencil,colorSpace:t.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{let et={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:r};d=new XRWebGLLayer(s,e,et),s.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),x=new vn(d.framebufferWidth,d.framebufferHeight,{format:cn,type:un,colorSpace:t.outputColorSpace,stencilBuffer:M.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}x.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),kt.setContext(s),kt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function X($){for(let it=0;it<$.removed.length;it++){let et=$.removed[it],It=T.indexOf(et);It>=0&&(T[It]=null,S[It].disconnect(et))}for(let it=0;it<$.added.length;it++){let et=$.added[it],It=T.indexOf(et);if(It===-1){for(let Ct=0;Ct<S.length;Ct++)if(Ct>=T.length){T.push(et),It=Ct;break}else if(T[Ct]===null){T[Ct]=et,It=Ct;break}if(It===-1)break}let Nt=S[It];Nt&&Nt.connect(et)}}let K=new L,tt=new L;function rt($,it,et){K.setFromMatrixPosition(it.matrixWorld),tt.setFromMatrixPosition(et.matrixWorld);let It=K.distanceTo(tt),Nt=it.projectionMatrix.elements,Ct=et.projectionMatrix.elements,de=Nt[14]/(Nt[10]-1),Ht=Nt[14]/(Nt[10]+1),re=(Nt[9]+1)/Nt[5],$t=(Nt[9]-1)/Nt[5],qt=(Nt[8]-1)/Nt[0],Ee=(Ct[8]+1)/Ct[0],Pe=de*qt,Ne=de*Ee,Oe=It/(-qt+Ee),_e=Oe*-qt;if(it.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(_e),$.translateZ(Oe),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Nt[10]===-1)$.projectionMatrix.copy(it.projectionMatrix),$.projectionMatrixInverse.copy(it.projectionMatrixInverse);else{let Ae=de+Oe,F=Ht+Oe,on=Pe-_e,ee=Ne+(It-_e),I=re*Ht/F*Ae,v=$t*Ht/F*Ae;$.projectionMatrix.makePerspective(on,ee,I,v,Ae,F),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function ht($,it){it===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(it.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(s===null)return;let it=$.near,et=$.far;m.texture!==null&&(m.depthNear>0&&(it=m.depthNear),m.depthFar>0&&(et=m.depthFar)),R.near=C.near=A.near=it,R.far=C.far=A.far=et,(D!==R.near||O!==R.far)&&(s.updateRenderState({depthNear:R.near,depthFar:R.far}),D=R.near,O=R.far),R.layers.mask=$.layers.mask|6,A.layers.mask=R.layers.mask&-5,C.layers.mask=R.layers.mask&-3;let It=$.parent,Nt=R.cameras;ht(R,It);for(let Ct=0;Ct<Nt.length;Ct++)ht(Nt[Ct],It);Nt.length===2?rt(R,A,C):R.projectionMatrix.copy(A.projectionMatrix),gt($,R,It)};function gt($,it,et){et===null?$.matrix.copy(it.matrixWorld):($.matrix.copy(et.matrixWorld),$.matrix.invert(),$.matrix.multiply(it.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(it.projectionMatrix),$.projectionMatrixInverse.copy(it.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=Us*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return R},this.getFoveation=function(){if(!(h===null&&d===null))return l},this.setFoveation=function($){l=$,h!==null&&(h.fixedFoveation=$),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=$)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(R)},this.getCameraTexture=function($){return p[$]};let Wt=null;function ge($,it){if(u=it.getViewerPose(c||o),g=it,u!==null){let et=u.views;d!==null&&(t.setRenderTargetFramebuffer(x,d.framebuffer),t.setRenderTarget(x));let It=!1;et.length!==R.cameras.length&&(R.cameras.length=0,It=!0);for(let Ht=0;Ht<et.length;Ht++){let re=et[Ht],$t=null;if(d!==null)$t=d.getViewport(re);else{let Ee=f.getViewSubImage(h,re);$t=Ee.viewport,Ht===0&&(t.setRenderTargetTextures(x,Ee.colorTexture,Ee.depthStencilTexture),t.setRenderTarget(x))}let qt=P[Ht];qt===void 0&&(qt=new Je,qt.layers.enable(Ht),qt.viewport=new me,P[Ht]=qt),qt.matrix.fromArray(re.transform.matrix),qt.matrix.decompose(qt.position,qt.quaternion,qt.scale),qt.projectionMatrix.fromArray(re.projectionMatrix),qt.projectionMatrixInverse.copy(qt.projectionMatrix).invert(),qt.viewport.set($t.x,$t.y,$t.width,$t.height),Ht===0&&(R.matrix.copy(qt.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale)),It===!0&&R.cameras.push(qt)}let Nt=s.enabledFeatures;if(Nt&&Nt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&y){f=n.getBinding();let Ht=f.getDepthInformation(et[0]);Ht&&Ht.isValid&&Ht.texture&&m.init(Ht,s.renderState)}if(Nt&&Nt.includes("camera-access")&&y){t.state.unbindTexture(),f=n.getBinding();for(let Ht=0;Ht<et.length;Ht++){let re=et[Ht].camera;if(re){let $t=p[re];$t||($t=new Ur,p[re]=$t);let qt=f.getCameraImage(re);$t.sourceTexture=qt}}}}for(let et=0;et<S.length;et++){let It=T[et],Nt=S[et];It!==null&&Nt!==void 0&&Nt.update(It,it,c||o)}Wt&&Wt($,it),it.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:it}),g=null}let kt=new vd;kt.setAnimationLoop(ge),this.setAnimationLoop=function($){Wt=$},this.dispose=function(){}}},By=new Ft,Ad=new Lt;Ad.set(-1,0,0,0,1,0,0,0,1);function Oy(i,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Th(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,M,b,x){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),f(m,p)):p.isMeshPhongMaterial?(r(m,p),u(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),h(m,p),p.isMeshPhysicalMaterial&&d(m,p,x)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),y(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?l(m,p,M,b):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Ge&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Ge&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let M=t.get(p),b=M.envMap,x=M.envMapRotation;b&&(m.envMap.value=b,m.envMapRotation.value.setFromMatrix4(By.makeRotationFromEuler(x)).transpose(),b.isCubeTexture&&b.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Ad),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,M,b){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*M,m.scale.value=b*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function f(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function h(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function d(m,p,M){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Ge&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=M.texture,m.transmissionSamplerSize.value.set(M.width,M.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function y(m,p){let M=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(M.matrixWorld),m.nearDistance.value=M.shadow.camera.near,m.farDistance.value=M.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function zy(i,t,e,n){let s={},r={},o=[],a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(x,S){let T=S.program;n.uniformBlockBinding(x,T)}function c(x,S){let T=s[x.id];T===void 0&&(m(x),T=u(x),s[x.id]=T,x.addEventListener("dispose",M));let w=S.program;n.updateUBOMapping(x,w);let _=t.render.frame;r[x.id]!==_&&(h(x),r[x.id]=_)}function u(x){let S=f();x.__bindingPointIndex=S;let T=i.createBuffer(),w=x.__size,_=x.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,w,_),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,S,T),T}function f(){for(let x=0;x<a;x++)if(o.indexOf(x)===-1)return o.push(x),x;return Pt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(x){let S=s[x.id],T=x.uniforms,w=x.__cache;i.bindBuffer(i.UNIFORM_BUFFER,S);for(let _=0,A=T.length;_<A;_++){let C=T[_];if(Array.isArray(C))for(let P=0,R=C.length;P<R;P++)d(C[P],_,P,w);else d(C,_,0,w)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function d(x,S,T,w){if(y(x,S,T,w)===!0){let _=x.__offset,A=x.value;if(Array.isArray(A)){let C=0;for(let P=0;P<A.length;P++){let R=A[P],D=p(R);g(R,x.__data,C),typeof R!="number"&&typeof R!="boolean"&&!R.isMatrix3&&!ArrayBuffer.isView(R)&&(C+=D.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(A,x.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,_,x.__data)}}function g(x,S,T){typeof x=="number"||typeof x=="boolean"?S[0]=x:x.isMatrix3?(S[0]=x.elements[0],S[1]=x.elements[1],S[2]=x.elements[2],S[3]=0,S[4]=x.elements[3],S[5]=x.elements[4],S[6]=x.elements[5],S[7]=0,S[8]=x.elements[6],S[9]=x.elements[7],S[10]=x.elements[8],S[11]=0):ArrayBuffer.isView(x)?S.set(new x.constructor(x.buffer,x.byteOffset,S.length)):x.toArray(S,T)}function y(x,S,T,w){let _=x.value,A=S+"_"+T;if(w[A]===void 0)return typeof _=="number"||typeof _=="boolean"?w[A]=_:ArrayBuffer.isView(_)?w[A]=_.slice():w[A]=_.clone(),!0;{let C=w[A];if(typeof _=="number"||typeof _=="boolean"){if(C!==_)return w[A]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(C.equals(_)===!1)return C.copy(_),!0}}return!1}function m(x){let S=x.uniforms,T=0,w=16;for(let A=0,C=S.length;A<C;A++){let P=Array.isArray(S[A])?S[A]:[S[A]];for(let R=0,D=P.length;R<D;R++){let O=P[R],N=Array.isArray(O.value)?O.value:[O.value];for(let H=0,X=N.length;H<X;H++){let K=N[H],tt=p(K),rt=T%w,ht=rt%tt.boundary,gt=rt+ht;T+=ht,gt!==0&&w-gt<tt.storage&&(T+=w-gt),O.__data=new Float32Array(tt.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=T,T+=tt.storage}}}let _=T%w;return _>0&&(T+=w-_),x.__size=T,x.__cache={},this}function p(x){let S={boundary:0,storage:0};return typeof x=="number"||typeof x=="boolean"?(S.boundary=4,S.storage=4):x.isVector2?(S.boundary=8,S.storage=8):x.isVector3||x.isColor?(S.boundary=16,S.storage=12):x.isVector4?(S.boundary=16,S.storage=16):x.isMatrix3?(S.boundary=48,S.storage=48):x.isMatrix4?(S.boundary=64,S.storage=64):x.isTexture?wt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(x)?(S.boundary=16,S.storage=x.byteLength):wt("WebGLRenderer: Unsupported uniform value type.",x),S}function M(x){let S=x.target;S.removeEventListener("dispose",M);let T=o.indexOf(S.__bindingPointIndex);o.splice(T,1),i.deleteBuffer(s[S.id]),delete s[S.id],delete r[S.id]}function b(){for(let x in s)i.deleteBuffer(s[x]);o=[],s={},r={}}return{bind:l,update:c,dispose:b}}var Vy=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Jn=null;function ky(){return Jn===null&&(Jn=new es(Vy,16,16,Fi,$n),Jn.name="DFG_LUT",Jn.minFilter=ke,Jn.magFilter=ke,Jn.wrapS=Wn,Jn.wrapT=Wn,Jn.generateMipmaps=!1,Jn.needsUpdate=!0),Jn}var Pl=class{constructor(t={}){let{canvas:e=Xf(),context:n=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:d=un}=t;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=o;let y=d,m=new Set([qa,Xa,Kr]),p=new Set([un,wn,Xs,qs,Ha,Wa]),M=new Uint32Array(4),b=new Int32Array(4),x=new L,S=null,T=null,w=[],_=[],A=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Bn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let C=this,P=!1,R=null,D=null,O=null,N=null;this._outputColorSpace=en;let H=0,X=0,K=null,tt=-1,rt=null,ht=new me,gt=new me,Wt=null,ge=new Dt(0),kt=0,$=e.width,it=e.height,et=1,It=null,Nt=null,Ct=new me(0,0,$,it),de=new me(0,0,$,it),Ht=!1,re=new li,$t=!1,qt=!1,Ee=new Ft,Pe=new L,Ne=new me,Oe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},_e=!1;function Ae(){return K===null?et:1}let F=n;function on(E,B){return e.getContext(E,B)}try{let E={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"185"}`),e.addEventListener("webglcontextlost",xe,!1),e.addEventListener("webglcontextrestored",he,!1),e.addEventListener("webglcontextcreationerror",Vn,!1),F===null){let B="webgl2";if(F=on(B,E),F===null)throw on(B)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(E){throw Pt("WebGLRenderer: "+E.message),E}let ee,I,v,z,G,q,nt,ot,Y,J,at,bt,ut,lt,At,Rt,Bt,U,st,Z,ct,mt,Q;function St(){ee=new Z0(F),ee.init(),ct=new Ny(F,ee),I=new V0(F,ee,t,ct),v=new Ly(F,ee),I.reversedDepthBuffer&&h&&v.buffers.depth.setReversed(!0),D=F.createFramebuffer(),O=F.createFramebuffer(),N=F.createFramebuffer(),z=new K0(F),G=new xy,q=new Dy(F,ee,v,G,I,ct,z),nt=new Y0(C),ot=new eg(F),mt=new O0(F,ot),Y=new $0(F,ot,z,mt),J=new Q0(F,Y,ot,mt,z),U=new j0(F,I,q),At=new k0(G),at=new _y(C,nt,ee,I,mt,At),bt=new Oy(C,G),ut=new vy,lt=new Ay(ee),Bt=new B0(C,nt,v,J,g,l),Rt=new Iy(C,J,I),Q=new zy(F,z,I,v),st=new z0(F,ee,z),Z=new J0(F,ee,z),z.programs=at.programs,C.capabilities=I,C.extensions=ee,C.properties=G,C.renderLists=ut,C.shadowMap=Rt,C.state=v,C.info=z}St(),y!==un&&(A=new ex(y,e.width,e.height,a,s,r));let yt=new Gh(C,F);this.xr=yt,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let E=ee.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){let E=ee.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return et},this.setPixelRatio=function(E){E!==void 0&&(et=E,this.setSize($,it,!1))},this.getSize=function(E){return E.set($,it)},this.setSize=function(E,B,W=!0){if(yt.isPresenting){wt("WebGLRenderer: Can't change size while VR device is presenting.");return}$=E,it=B,e.width=Math.floor(E*et),e.height=Math.floor(B*et),W===!0&&(e.style.width=E+"px",e.style.height=B+"px"),A!==null&&A.setSize(e.width,e.height),this.setViewport(0,0,E,B)},this.getDrawingBufferSize=function(E){return E.set($*et,it*et).floor()},this.setDrawingBufferSize=function(E,B,W){$=E,it=B,et=W,e.width=Math.floor(E*W),e.height=Math.floor(B*W),this.setViewport(0,0,E,B)},this.setEffects=function(E){if(y===un){Pt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(E){for(let B=0;B<E.length;B++)if(E[B].isOutputPass===!0){wt("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(E||[])},this.getCurrentViewport=function(E){return E.copy(ht)},this.getViewport=function(E){return E.copy(Ct)},this.setViewport=function(E,B,W,V){E.isVector4?Ct.set(E.x,E.y,E.z,E.w):Ct.set(E,B,W,V),v.viewport(ht.copy(Ct).multiplyScalar(et).round())},this.getScissor=function(E){return E.copy(de)},this.setScissor=function(E,B,W,V){E.isVector4?de.set(E.x,E.y,E.z,E.w):de.set(E,B,W,V),v.scissor(gt.copy(de).multiplyScalar(et).round())},this.getScissorTest=function(){return Ht},this.setScissorTest=function(E){v.setScissorTest(Ht=E)},this.setOpaqueSort=function(E){It=E},this.setTransparentSort=function(E){Nt=E},this.getClearColor=function(E){return E.copy(Bt.getClearColor())},this.setClearColor=function(){Bt.setClearColor(...arguments)},this.getClearAlpha=function(){return Bt.getClearAlpha()},this.setClearAlpha=function(){Bt.setClearAlpha(...arguments)},this.clear=function(E=!0,B=!0,W=!0){let V=0;if(E){let k=!1;if(K!==null){let pt=K.texture.format;k=m.has(pt)}if(k){let pt=K.texture.type,xt=p.has(pt),dt=Bt.getClearColor(),vt=Bt.getClearAlpha(),Tt=dt.r,Ot=dt.g,Vt=dt.b;xt?(M[0]=Tt,M[1]=Ot,M[2]=Vt,M[3]=vt,F.clearBufferuiv(F.COLOR,0,M)):(b[0]=Tt,b[1]=Ot,b[2]=Vt,b[3]=vt,F.clearBufferiv(F.COLOR,0,b))}else V|=F.COLOR_BUFFER_BIT}B&&(V|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),W&&(V|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V!==0&&F.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(E){E.setRenderer(this),R=E},this.dispose=function(){e.removeEventListener("webglcontextlost",xe,!1),e.removeEventListener("webglcontextrestored",he,!1),e.removeEventListener("webglcontextcreationerror",Vn,!1),Bt.dispose(),ut.dispose(),lt.dispose(),G.dispose(),nt.dispose(),J.dispose(),mt.dispose(),Q.dispose(),at.dispose(),yt.dispose(),yt.removeEventListener("sessionstart",Au),yt.removeEventListener("sessionend",wu),qi.stop()};function xe(E){E.preventDefault(),Sh("WebGLRenderer: Context Lost."),P=!0}function he(){Sh("WebGLRenderer: Context Restored."),P=!1;let E=z.autoReset,B=Rt.enabled,W=Rt.autoUpdate,V=Rt.needsUpdate,k=Rt.type;St(),z.autoReset=E,Rt.enabled=B,Rt.autoUpdate=W,Rt.needsUpdate=V,Rt.type=k}function Vn(E){Pt("WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function kn(E){let B=E.target;B.removeEventListener("dispose",kn),Xp(B)}function Xp(E){qp(E),G.remove(E)}function qp(E){let B=G.get(E).programs;B!==void 0&&(B.forEach(function(W){at.releaseProgram(W)}),E.isShaderMaterial&&at.releaseShaderCache(E))}this.renderBufferDirect=function(E,B,W,V,k,pt){B===null&&(B=Oe);let xt=k.isMesh&&k.matrixWorld.determinantAffine()<0,dt=$p(E,B,W,V,k);v.setMaterial(V,xt);let vt=W.index,Tt=1;if(V.wireframe===!0){if(vt=Y.getWireframeAttribute(W),vt===void 0)return;Tt=2}let Ot=W.drawRange,Vt=W.attributes.position,Et=Ot.start*Tt,ne=(Ot.start+Ot.count)*Tt;pt!==null&&(Et=Math.max(Et,pt.start*Tt),ne=Math.min(ne,(pt.start+pt.count)*Tt)),vt!==null?(Et=Math.max(Et,0),ne=Math.min(ne,vt.count)):Vt!=null&&(Et=Math.max(Et,0),ne=Math.min(ne,Vt.count));let Se=ne-Et;if(Se<0||Se===1/0)return;mt.setup(k,V,dt,W,vt);let ye,oe=st;if(vt!==null&&(ye=ot.get(vt),oe=Z,oe.setIndex(ye)),k.isMesh)V.wireframe===!0?(v.setLineWidth(V.wireframeLinewidth*Ae()),oe.setMode(F.LINES)):oe.setMode(F.TRIANGLES);else if(k.isLine){let Xe=V.linewidth;Xe===void 0&&(Xe=1),v.setLineWidth(Xe*Ae()),k.isLineSegments?oe.setMode(F.LINES):k.isLineLoop?oe.setMode(F.LINE_LOOP):oe.setMode(F.LINE_STRIP)}else k.isPoints?oe.setMode(F.POINTS):k.isSprite&&oe.setMode(F.TRIANGLES);if(k.isBatchedMesh)if(ee.get("WEBGL_multi_draw"))oe.renderMultiDraw(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount);else{let Xe=k._multiDrawStarts,_t=k._multiDrawCounts,mn=k._multiDrawCount,Yt=vt?ot.get(vt).bytesPerElement:1,Tn=G.get(V).currentProgram.getUniforms();for(let Gn=0;Gn<mn;Gn++)Tn.setValue(F,"_gl_DrawID",Gn),oe.render(Xe[Gn]/Yt,_t[Gn])}else if(k.isInstancedMesh)oe.renderInstances(Et,Se,k.count);else if(W.isInstancedBufferGeometry){let Xe=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,_t=Math.min(W.instanceCount,Xe);oe.renderInstances(Et,Se,_t)}else oe.render(Et,Se)};function Eu(E,B,W){E.transparent===!0&&E.side===Ke&&E.forceSinglePass===!1?(E.side=Ge,E.needsUpdate=!0,Ao(E,B,W),E.side=nn,E.needsUpdate=!0,Ao(E,B,W),E.side=Ke):Ao(E,B,W)}this.compile=function(E,B,W=null){W===null&&(W=E),T=lt.get(W),T.init(B),_.push(T),W.traverseVisible(function(k){k.isLight&&k.layers.test(B.layers)&&(T.pushLight(k),k.castShadow&&T.pushShadow(k))}),E!==W&&E.traverseVisible(function(k){k.isLight&&k.layers.test(B.layers)&&(T.pushLight(k),k.castShadow&&T.pushShadow(k))}),T.setupLights();let V=new Set;return E.traverse(function(k){if(!(k.isMesh||k.isPoints||k.isLine||k.isSprite))return;let pt=k.material;if(pt)if(Array.isArray(pt))for(let xt=0;xt<pt.length;xt++){let dt=pt[xt];Eu(dt,W,k),V.add(dt)}else Eu(pt,W,k),V.add(pt)}),T=_.pop(),V},this.compileAsync=function(E,B,W=null){let V=this.compile(E,B,W);return new Promise(k=>{function pt(){if(V.forEach(function(xt){G.get(xt).currentProgram.isReady()&&V.delete(xt)}),V.size===0){k(E);return}setTimeout(pt,10)}ee.get("KHR_parallel_shader_compile")!==null?pt():setTimeout(pt,10)})};let pc=null;function Yp(E){pc&&pc(E)}function Au(){qi.stop()}function wu(){qi.start()}let qi=new vd;qi.setAnimationLoop(Yp),typeof self<"u"&&qi.setContext(self),this.setAnimationLoop=function(E){pc=E,yt.setAnimationLoop(E),E===null?qi.stop():qi.start()},yt.addEventListener("sessionstart",Au),yt.addEventListener("sessionend",wu),this.render=function(E,B){if(B!==void 0&&B.isCamera!==!0){Pt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;R!==null&&R.renderStart(E,B);let W=yt.enabled===!0&&yt.isPresenting===!0,V=A!==null&&(K===null||W)&&A.begin(C,K);if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),yt.enabled===!0&&yt.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(yt.cameraAutoUpdate===!0&&yt.updateCamera(B),B=yt.getCamera()),E.isScene===!0&&E.onBeforeRender(C,E,B,K),T=lt.get(E,_.length),T.init(B),T.state.textureUnits=q.getTextureUnits(),_.push(T),Ee.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),re.setFromProjectionMatrix(Ee,An,B.reversedDepth),qt=this.localClippingEnabled,$t=At.init(this.clippingPlanes,qt),S=ut.get(E,w.length),S.init(),w.push(S),yt.enabled===!0&&yt.isPresenting===!0){let xt=C.xr.getDepthSensingMesh();xt!==null&&mc(xt,B,-1/0,C.sortObjects)}mc(E,B,0,C.sortObjects),S.finish(),C.sortObjects===!0&&S.sort(It,Nt,B.reversedDepth),_e=yt.enabled===!1||yt.isPresenting===!1||yt.hasDepthSensing()===!1,_e&&Bt.addToRenderList(S,E),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),$t===!0&&At.beginShadows();let k=T.state.shadowsArray;if(Rt.render(k,E,B),$t===!0&&At.endShadows(),(V&&A.hasRenderPass())===!1){let xt=S.opaque,dt=S.transmissive;if(T.setupLights(),B.isArrayCamera){let vt=B.cameras;if(dt.length>0)for(let Tt=0,Ot=vt.length;Tt<Ot;Tt++){let Vt=vt[Tt];Ru(xt,dt,E,Vt)}_e&&Bt.render(E);for(let Tt=0,Ot=vt.length;Tt<Ot;Tt++){let Vt=vt[Tt];Cu(S,E,Vt,Vt.viewport)}}else dt.length>0&&Ru(xt,dt,E,B),_e&&Bt.render(E),Cu(S,E,B)}K!==null&&X===0&&(q.updateMultisampleRenderTarget(K),q.updateRenderTargetMipmap(K)),V&&A.end(C),E.isScene===!0&&E.onAfterRender(C,E,B),mt.resetDefaultState(),tt=-1,rt=null,_.pop(),_.length>0?(T=_[_.length-1],q.setTextureUnits(T.state.textureUnits),$t===!0&&At.setGlobalState(C.clippingPlanes,T.state.camera)):T=null,w.pop(),w.length>0?S=w[w.length-1]:S=null,R!==null&&R.renderEnd()};function mc(E,B,W,V){if(E.visible===!1)return;if(E.layers.test(B.layers)){if(E.isGroup)W=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(B);else if(E.isLightProbeGrid)T.pushLightProbeGrid(E);else if(E.isLight)T.pushLight(E),E.castShadow&&T.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||re.intersectsSprite(E)){V&&Ne.setFromMatrixPosition(E.matrixWorld).applyMatrix4(Ee);let xt=J.update(E),dt=E.material;dt.visible&&S.push(E,xt,dt,W,Ne.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||re.intersectsObject(E))){let xt=J.update(E),dt=E.material;if(V&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),Ne.copy(E.boundingSphere.center)):(xt.boundingSphere===null&&xt.computeBoundingSphere(),Ne.copy(xt.boundingSphere.center)),Ne.applyMatrix4(E.matrixWorld).applyMatrix4(Ee)),Array.isArray(dt)){let vt=xt.groups;for(let Tt=0,Ot=vt.length;Tt<Ot;Tt++){let Vt=vt[Tt],Et=dt[Vt.materialIndex];Et&&Et.visible&&S.push(E,xt,Et,W,Ne.z,Vt)}}else dt.visible&&S.push(E,xt,dt,W,Ne.z,null)}}let pt=E.children;for(let xt=0,dt=pt.length;xt<dt;xt++)mc(pt[xt],B,W,V)}function Cu(E,B,W,V){let{opaque:k,transmissive:pt,transparent:xt}=E;T.setupLightsView(W),$t===!0&&At.setGlobalState(C.clippingPlanes,W),V&&v.viewport(ht.copy(V)),k.length>0&&Eo(k,B,W),pt.length>0&&Eo(pt,B,W),xt.length>0&&Eo(xt,B,W),v.buffers.depth.setTest(!0),v.buffers.depth.setMask(!0),v.buffers.color.setMask(!0),v.setPolygonOffset(!1)}function Ru(E,B,W,V){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[V.id]===void 0){let Et=ee.has("EXT_color_buffer_half_float")||ee.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[V.id]=new vn(1,1,{generateMipmaps:!0,type:Et?$n:un,minFilter:Ni,samples:Math.max(4,I.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Gt.workingColorSpace})}let pt=T.state.transmissionRenderTarget[V.id],xt=V.viewport||ht;pt.setSize(xt.z*C.transmissionResolutionScale,xt.w*C.transmissionResolutionScale);let dt=C.getRenderTarget(),vt=C.getActiveCubeFace(),Tt=C.getActiveMipmapLevel();C.setRenderTarget(pt),C.getClearColor(ge),kt=C.getClearAlpha(),kt<1&&C.setClearColor(16777215,.5),C.clear(),_e&&Bt.render(W);let Ot=C.toneMapping;C.toneMapping=Bn;let Vt=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),T.setupLightsView(V),$t===!0&&At.setGlobalState(C.clippingPlanes,V),Eo(E,W,V),q.updateMultisampleRenderTarget(pt),q.updateRenderTargetMipmap(pt),ee.has("WEBGL_multisampled_render_to_texture")===!1){let Et=!1;for(let ne=0,Se=B.length;ne<Se;ne++){let ye=B[ne],{object:oe,geometry:Xe,material:_t,group:mn}=ye;if(_t.side===Ke&&oe.layers.test(V.layers)){let Yt=_t.side;_t.side=Ge,_t.needsUpdate=!0,Pu(oe,W,V,Xe,_t,mn),_t.side=Yt,_t.needsUpdate=!0,Et=!0}}Et===!0&&(q.updateMultisampleRenderTarget(pt),q.updateRenderTargetMipmap(pt))}C.setRenderTarget(dt,vt,Tt),C.setClearColor(ge,kt),Vt!==void 0&&(V.viewport=Vt),C.toneMapping=Ot}function Eo(E,B,W){let V=B.isScene===!0?B.overrideMaterial:null;for(let k=0,pt=E.length;k<pt;k++){let xt=E[k],{object:dt,geometry:vt,group:Tt}=xt,Ot=xt.material;Ot.allowOverride===!0&&V!==null&&(Ot=V),dt.layers.test(W.layers)&&Pu(dt,B,W,vt,Ot,Tt)}}function Pu(E,B,W,V,k,pt){E.onBeforeRender(C,B,W,V,k,pt),E.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),k.onBeforeRender(C,B,W,V,E,pt),k.transparent===!0&&k.side===Ke&&k.forceSinglePass===!1?(k.side=Ge,k.needsUpdate=!0,C.renderBufferDirect(W,B,V,k,E,pt),k.side=nn,k.needsUpdate=!0,C.renderBufferDirect(W,B,V,k,E,pt),k.side=Ke):C.renderBufferDirect(W,B,V,k,E,pt),E.onAfterRender(C,B,W,V,k,pt)}function Ao(E,B,W){B.isScene!==!0&&(B=Oe);let V=G.get(E),k=T.state.lights,pt=T.state.shadowsArray,xt=k.state.version,dt=at.getParameters(E,k.state,pt,B,W,T.state.lightProbeGridArray),vt=at.getProgramCacheKey(dt),Tt=V.programs;V.environment=E.isMeshStandardMaterial||E.isMeshLambertMaterial||E.isMeshPhongMaterial?B.environment:null,V.fog=B.fog;let Ot=E.isMeshStandardMaterial||E.isMeshLambertMaterial&&!E.envMap||E.isMeshPhongMaterial&&!E.envMap;V.envMap=nt.get(E.envMap||V.environment,Ot),V.envMapRotation=V.environment!==null&&E.envMap===null?B.environmentRotation:E.envMapRotation,Tt===void 0&&(E.addEventListener("dispose",kn),Tt=new Map,V.programs=Tt);let Vt=Tt.get(vt);if(Vt!==void 0){if(V.currentProgram===Vt&&V.lightsStateVersion===xt)return Lu(E,dt),Vt}else dt.uniforms=at.getUniforms(E),R!==null&&E.isNodeMaterial&&R.build(E,W,dt),E.onBeforeCompile(dt,C),Vt=at.acquireProgram(dt,vt),Tt.set(vt,Vt),V.uniforms=dt.uniforms;let Et=V.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Et.clippingPlanes=At.uniform),Lu(E,dt),V.needsLights=Kp(E),V.lightsStateVersion=xt,V.needsLights&&(Et.ambientLightColor.value=k.state.ambient,Et.lightProbe.value=k.state.probe,Et.directionalLights.value=k.state.directional,Et.directionalLightShadows.value=k.state.directionalShadow,Et.spotLights.value=k.state.spot,Et.spotLightShadows.value=k.state.spotShadow,Et.rectAreaLights.value=k.state.rectArea,Et.ltc_1.value=k.state.rectAreaLTC1,Et.ltc_2.value=k.state.rectAreaLTC2,Et.pointLights.value=k.state.point,Et.pointLightShadows.value=k.state.pointShadow,Et.hemisphereLights.value=k.state.hemi,Et.directionalShadowMatrix.value=k.state.directionalShadowMatrix,Et.spotLightMatrix.value=k.state.spotLightMatrix,Et.spotLightMap.value=k.state.spotLightMap,Et.pointShadowMatrix.value=k.state.pointShadowMatrix),V.lightProbeGrid=T.state.lightProbeGridArray.length>0,V.currentProgram=Vt,V.uniformsList=null,Vt}function Iu(E){if(E.uniformsList===null){let B=E.currentProgram.getUniforms();E.uniformsList=$s.seqWithValue(B.seq,E.uniforms)}return E.uniformsList}function Lu(E,B){let W=G.get(E);W.outputColorSpace=B.outputColorSpace,W.batching=B.batching,W.batchingColor=B.batchingColor,W.instancing=B.instancing,W.instancingColor=B.instancingColor,W.instancingMorph=B.instancingMorph,W.skinning=B.skinning,W.morphTargets=B.morphTargets,W.morphNormals=B.morphNormals,W.morphColors=B.morphColors,W.morphTargetsCount=B.morphTargetsCount,W.numClippingPlanes=B.numClippingPlanes,W.numIntersection=B.numClipIntersection,W.vertexAlphas=B.vertexAlphas,W.vertexTangents=B.vertexTangents,W.toneMapping=B.toneMapping}function Zp(E,B){if(E.length===0)return null;if(E.length===1)return E[0].texture!==null?E[0]:null;x.setFromMatrixPosition(B.matrixWorld);for(let W=0,V=E.length;W<V;W++){let k=E[W];if(k.texture!==null&&k.boundingBox.containsPoint(x))return k}return null}function $p(E,B,W,V,k){B.isScene!==!0&&(B=Oe),q.resetTextureUnits();let pt=B.fog,xt=V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial?B.environment:null,dt=K===null?C.outputColorSpace:K.isXRRenderTarget===!0?K.texture.colorSpace:Gt.workingColorSpace,vt=V.isMeshStandardMaterial||V.isMeshLambertMaterial&&!V.envMap||V.isMeshPhongMaterial&&!V.envMap,Tt=nt.get(V.envMap||xt,vt),Ot=V.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Vt=!!W.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Et=!!W.morphAttributes.position,ne=!!W.morphAttributes.normal,Se=!!W.morphAttributes.color,ye=Bn;V.toneMapped&&(K===null||K.isXRRenderTarget===!0)&&(ye=C.toneMapping);let oe=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,Xe=oe!==void 0?oe.length:0,_t=G.get(V),mn=T.state.lights;if($t===!0&&(qt===!0||E!==rt)){let ue=E===rt&&V.id===tt;At.setState(V,E,ue)}let Yt=!1;V.version===_t.__version?(_t.needsLights&&_t.lightsStateVersion!==mn.state.version||_t.outputColorSpace!==dt||k.isBatchedMesh&&_t.batching===!1||!k.isBatchedMesh&&_t.batching===!0||k.isBatchedMesh&&_t.batchingColor===!0&&k.colorTexture===null||k.isBatchedMesh&&_t.batchingColor===!1&&k.colorTexture!==null||k.isInstancedMesh&&_t.instancing===!1||!k.isInstancedMesh&&_t.instancing===!0||k.isSkinnedMesh&&_t.skinning===!1||!k.isSkinnedMesh&&_t.skinning===!0||k.isInstancedMesh&&_t.instancingColor===!0&&k.instanceColor===null||k.isInstancedMesh&&_t.instancingColor===!1&&k.instanceColor!==null||k.isInstancedMesh&&_t.instancingMorph===!0&&k.morphTexture===null||k.isInstancedMesh&&_t.instancingMorph===!1&&k.morphTexture!==null||_t.envMap!==Tt||V.fog===!0&&_t.fog!==pt||_t.numClippingPlanes!==void 0&&(_t.numClippingPlanes!==At.numPlanes||_t.numIntersection!==At.numIntersection)||_t.vertexAlphas!==Ot||_t.vertexTangents!==Vt||_t.morphTargets!==Et||_t.morphNormals!==ne||_t.morphColors!==Se||_t.toneMapping!==ye||_t.morphTargetsCount!==Xe||!!_t.lightProbeGrid!=T.state.lightProbeGridArray.length>0)&&(Yt=!0):(Yt=!0,_t.__version=V.version);let Tn=_t.currentProgram;Yt===!0&&(Tn=Ao(V,B,k),R&&V.isNodeMaterial&&R.onUpdateProgram(V,Tn,_t));let Gn=!1,_i=!1,ps=!1,ae=Tn.getUniforms(),be=_t.uniforms;if(v.useProgram(Tn.program)&&(Gn=!0,_i=!0,ps=!0),V.id!==tt&&(tt=V.id,_i=!0),_t.needsLights){let ue=Zp(T.state.lightProbeGridArray,k);_t.lightProbeGrid!==ue&&(_t.lightProbeGrid=ue,_i=!0)}if(Gn||rt!==E){v.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),ae.setValue(F,"projectionMatrix",E.projectionMatrix),ae.setValue(F,"viewMatrix",E.matrixWorldInverse);let yi=ae.map.cameraPosition;yi!==void 0&&yi.setValue(F,Pe.setFromMatrixPosition(E.matrixWorld)),I.logarithmicDepthBuffer&&ae.setValue(F,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&ae.setValue(F,"isOrthographic",E.isOrthographicCamera===!0),rt!==E&&(rt=E,_i=!0,ps=!0)}if(_t.needsLights&&(mn.state.directionalShadowMap.length>0&&ae.setValue(F,"directionalShadowMap",mn.state.directionalShadowMap,q),mn.state.spotShadowMap.length>0&&ae.setValue(F,"spotShadowMap",mn.state.spotShadowMap,q),mn.state.pointShadowMap.length>0&&ae.setValue(F,"pointShadowMap",mn.state.pointShadowMap,q)),k.isSkinnedMesh){ae.setOptional(F,k,"bindMatrix"),ae.setOptional(F,k,"bindMatrixInverse");let ue=k.skeleton;ue&&(ue.boneTexture===null&&ue.computeBoneTexture(),ae.setValue(F,"boneTexture",ue.boneTexture,q))}k.isBatchedMesh&&(ae.setOptional(F,k,"batchingTexture"),ae.setValue(F,"batchingTexture",k._matricesTexture,q),ae.setOptional(F,k,"batchingIdTexture"),ae.setValue(F,"batchingIdTexture",k._indirectTexture,q),ae.setOptional(F,k,"batchingColorTexture"),k._colorsTexture!==null&&ae.setValue(F,"batchingColorTexture",k._colorsTexture,q));let xi=W.morphAttributes;if((xi.position!==void 0||xi.normal!==void 0||xi.color!==void 0)&&U.update(k,W,Tn),(_i||_t.receiveShadow!==k.receiveShadow)&&(_t.receiveShadow=k.receiveShadow,ae.setValue(F,"receiveShadow",k.receiveShadow)),(V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial)&&V.envMap===null&&B.environment!==null&&(be.envMapIntensity.value=B.environmentIntensity),be.dfgLUT!==void 0&&(be.dfgLUT.value=ky()),_i){if(ae.setValue(F,"toneMappingExposure",C.toneMappingExposure),_t.needsLights&&Jp(be,ps),pt&&V.fog===!0&&bt.refreshFogUniforms(be,pt),bt.refreshMaterialUniforms(be,V,et,it,T.state.transmissionRenderTarget[E.id]),_t.needsLights&&_t.lightProbeGrid){let ue=_t.lightProbeGrid;be.probesSH.value=ue.texture,be.probesMin.value.copy(ue.boundingBox.min),be.probesMax.value.copy(ue.boundingBox.max),be.probesResolution.value.copy(ue.resolution)}$s.upload(F,Iu(_t),be,q)}if(V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&($s.upload(F,Iu(_t),be,q),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&ae.setValue(F,"center",k.center),ae.setValue(F,"modelViewMatrix",k.modelViewMatrix),ae.setValue(F,"normalMatrix",k.normalMatrix),ae.setValue(F,"modelMatrix",k.matrixWorld),V.uniformsGroups!==void 0){let ue=V.uniformsGroups;for(let yi=0,ms=ue.length;yi<ms;yi++){let Du=ue[yi];Q.update(Du,Tn),Q.bind(Du,Tn)}}return Tn}function Jp(E,B){E.ambientLightColor.needsUpdate=B,E.lightProbe.needsUpdate=B,E.directionalLights.needsUpdate=B,E.directionalLightShadows.needsUpdate=B,E.pointLights.needsUpdate=B,E.pointLightShadows.needsUpdate=B,E.spotLights.needsUpdate=B,E.spotLightShadows.needsUpdate=B,E.rectAreaLights.needsUpdate=B,E.hemisphereLights.needsUpdate=B}function Kp(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return H},this.getActiveMipmapLevel=function(){return X},this.getRenderTarget=function(){return K},this.setRenderTargetTextures=function(E,B,W){let V=G.get(E);V.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),G.get(E.texture).__webglTexture=B,G.get(E.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:W,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,B){let W=G.get(E);W.__webglFramebuffer=B,W.__useDefaultFramebuffer=B===void 0},this.setRenderTarget=function(E,B=0,W=0){K=E,H=B,X=W;let V=null,k=!1,pt=!1;if(E){let dt=G.get(E);if(dt.__useDefaultFramebuffer!==void 0){v.bindFramebuffer(F.FRAMEBUFFER,dt.__webglFramebuffer),ht.copy(E.viewport),gt.copy(E.scissor),Wt=E.scissorTest,v.viewport(ht),v.scissor(gt),v.setScissorTest(Wt),tt=-1;return}else if(dt.__webglFramebuffer===void 0)q.setupRenderTarget(E);else if(dt.__hasExternalTextures)q.rebindTextures(E,G.get(E.texture).__webglTexture,G.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){let Ot=E.depthTexture;if(dt.__boundDepthTexture!==Ot){if(Ot!==null&&G.has(Ot)&&(E.width!==Ot.image.width||E.height!==Ot.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");q.setupDepthRenderbuffer(E)}}let vt=E.texture;(vt.isData3DTexture||vt.isDataArrayTexture||vt.isCompressedArrayTexture)&&(pt=!0);let Tt=G.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Tt[B])?V=Tt[B][W]:V=Tt[B],k=!0):E.samples>0&&q.useMultisampledRTT(E)===!1?V=G.get(E).__webglMultisampledFramebuffer:Array.isArray(Tt)?V=Tt[W]:V=Tt,ht.copy(E.viewport),gt.copy(E.scissor),Wt=E.scissorTest}else ht.copy(Ct).multiplyScalar(et).floor(),gt.copy(de).multiplyScalar(et).floor(),Wt=Ht;if(W!==0&&(V=D),v.bindFramebuffer(F.FRAMEBUFFER,V)&&v.drawBuffers(E,V),v.viewport(ht),v.scissor(gt),v.setScissorTest(Wt),k){let dt=G.get(E.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+B,dt.__webglTexture,W)}else if(pt){let dt=B;for(let vt=0;vt<E.textures.length;vt++){let Tt=G.get(E.textures[vt]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+vt,Tt.__webglTexture,W,dt)}}else if(E!==null&&W!==0){let dt=G.get(E.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,dt.__webglTexture,W)}tt=-1},this.readRenderTargetPixels=function(E,B,W,V,k,pt,xt,dt=0){if(!(E&&E.isWebGLRenderTarget)){Pt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let vt=G.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&xt!==void 0&&(vt=vt[xt]),vt){v.bindFramebuffer(F.FRAMEBUFFER,vt);try{let Tt=E.textures[dt],Ot=Tt.format,Vt=Tt.type;if(E.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+dt),!I.textureFormatReadable(Ot)){Pt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!I.textureTypeReadable(Vt)){Pt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=E.width-V&&W>=0&&W<=E.height-k&&F.readPixels(B,W,V,k,ct.convert(Ot),ct.convert(Vt),pt)}finally{let Tt=K!==null?G.get(K).__webglFramebuffer:null;v.bindFramebuffer(F.FRAMEBUFFER,Tt)}}},this.readRenderTargetPixelsAsync=async function(E,B,W,V,k,pt,xt,dt=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let vt=G.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&xt!==void 0&&(vt=vt[xt]),vt)if(B>=0&&B<=E.width-V&&W>=0&&W<=E.height-k){v.bindFramebuffer(F.FRAMEBUFFER,vt);let Tt=E.textures[dt],Ot=Tt.format,Vt=Tt.type;if(E.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+dt),!I.textureFormatReadable(Ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!I.textureTypeReadable(Vt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Et=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,Et),F.bufferData(F.PIXEL_PACK_BUFFER,pt.byteLength,F.STREAM_READ),F.readPixels(B,W,V,k,ct.convert(Ot),ct.convert(Vt),0);let ne=K!==null?G.get(K).__webglFramebuffer:null;v.bindFramebuffer(F.FRAMEBUFFER,ne);let Se=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await Yf(F,Se,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,Et),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,pt),F.deleteBuffer(Et),F.deleteSync(Se),pt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,B=null,W=0){let V=Math.pow(2,-W),k=Math.floor(E.image.width*V),pt=Math.floor(E.image.height*V),xt=B!==null?B.x:0,dt=B!==null?B.y:0;q.setTexture2D(E,0),F.copyTexSubImage2D(F.TEXTURE_2D,W,0,0,xt,dt,k,pt),v.unbindTexture()},this.copyTextureToTexture=function(E,B,W=null,V=null,k=0,pt=0){let xt,dt,vt,Tt,Ot,Vt,Et,ne,Se,ye=E.isCompressedTexture?E.mipmaps[pt]:E.image;if(W!==null)xt=W.max.x-W.min.x,dt=W.max.y-W.min.y,vt=W.isBox3?W.max.z-W.min.z:1,Tt=W.min.x,Ot=W.min.y,Vt=W.isBox3?W.min.z:0;else{let be=Math.pow(2,-k);xt=Math.floor(ye.width*be),dt=Math.floor(ye.height*be),E.isDataArrayTexture?vt=ye.depth:E.isData3DTexture?vt=Math.floor(ye.depth*be):vt=1,Tt=0,Ot=0,Vt=0}V!==null?(Et=V.x,ne=V.y,Se=V.z):(Et=0,ne=0,Se=0);let oe=ct.convert(B.format),Xe=ct.convert(B.type),_t;B.isData3DTexture?(q.setTexture3D(B,0),_t=F.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?(q.setTexture2DArray(B,0),_t=F.TEXTURE_2D_ARRAY):(q.setTexture2D(B,0),_t=F.TEXTURE_2D),v.activeTexture(F.TEXTURE0),v.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,B.flipY),v.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),v.pixelStorei(F.UNPACK_ALIGNMENT,B.unpackAlignment);let mn=v.getParameter(F.UNPACK_ROW_LENGTH),Yt=v.getParameter(F.UNPACK_IMAGE_HEIGHT),Tn=v.getParameter(F.UNPACK_SKIP_PIXELS),Gn=v.getParameter(F.UNPACK_SKIP_ROWS),_i=v.getParameter(F.UNPACK_SKIP_IMAGES);v.pixelStorei(F.UNPACK_ROW_LENGTH,ye.width),v.pixelStorei(F.UNPACK_IMAGE_HEIGHT,ye.height),v.pixelStorei(F.UNPACK_SKIP_PIXELS,Tt),v.pixelStorei(F.UNPACK_SKIP_ROWS,Ot),v.pixelStorei(F.UNPACK_SKIP_IMAGES,Vt);let ps=E.isDataArrayTexture||E.isData3DTexture,ae=B.isDataArrayTexture||B.isData3DTexture;if(E.isDepthTexture){let be=G.get(E),xi=G.get(B),ue=G.get(be.__renderTarget),yi=G.get(xi.__renderTarget);v.bindFramebuffer(F.READ_FRAMEBUFFER,ue.__webglFramebuffer),v.bindFramebuffer(F.DRAW_FRAMEBUFFER,yi.__webglFramebuffer);for(let ms=0;ms<vt;ms++)ps&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,G.get(E).__webglTexture,k,Vt+ms),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,G.get(B).__webglTexture,pt,Se+ms)),F.blitFramebuffer(Tt,Ot,xt,dt,Et,ne,xt,dt,F.DEPTH_BUFFER_BIT,F.NEAREST);v.bindFramebuffer(F.READ_FRAMEBUFFER,null),v.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(k!==0||E.isRenderTargetTexture||G.has(E)){let be=G.get(E),xi=G.get(B);v.bindFramebuffer(F.READ_FRAMEBUFFER,O),v.bindFramebuffer(F.DRAW_FRAMEBUFFER,N);for(let ue=0;ue<vt;ue++)ps?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,be.__webglTexture,k,Vt+ue):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,be.__webglTexture,k),ae?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,xi.__webglTexture,pt,Se+ue):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,xi.__webglTexture,pt),k!==0?F.blitFramebuffer(Tt,Ot,xt,dt,Et,ne,xt,dt,F.COLOR_BUFFER_BIT,F.NEAREST):ae?F.copyTexSubImage3D(_t,pt,Et,ne,Se+ue,Tt,Ot,xt,dt):F.copyTexSubImage2D(_t,pt,Et,ne,Tt,Ot,xt,dt);v.bindFramebuffer(F.READ_FRAMEBUFFER,null),v.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else ae?E.isDataTexture||E.isData3DTexture?F.texSubImage3D(_t,pt,Et,ne,Se,xt,dt,vt,oe,Xe,ye.data):B.isCompressedArrayTexture?F.compressedTexSubImage3D(_t,pt,Et,ne,Se,xt,dt,vt,oe,ye.data):F.texSubImage3D(_t,pt,Et,ne,Se,xt,dt,vt,oe,Xe,ye):E.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,pt,Et,ne,xt,dt,oe,Xe,ye.data):E.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,pt,Et,ne,ye.width,ye.height,oe,ye.data):F.texSubImage2D(F.TEXTURE_2D,pt,Et,ne,xt,dt,oe,Xe,ye);v.pixelStorei(F.UNPACK_ROW_LENGTH,mn),v.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Yt),v.pixelStorei(F.UNPACK_SKIP_PIXELS,Tn),v.pixelStorei(F.UNPACK_SKIP_ROWS,Gn),v.pixelStorei(F.UNPACK_SKIP_IMAGES,_i),pt===0&&B.generateMipmaps&&F.generateMipmap(_t),v.unbindTexture()},this.initRenderTarget=function(E){G.get(E).__webglFramebuffer===void 0&&q.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?q.setTextureCube(E,0):E.isData3DTexture?q.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?q.setTexture2DArray(E,0):q.setTexture2D(E,0),v.unbindTexture()},this.resetState=function(){H=0,X=0,K=null,v.reset(),mt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return An}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=Gt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Gt._getUnpackColorSpace()}};var wd={type:"change"},Wh={type:"start"},Rd={type:"end"},Dl=new Fn,Cd=new $e,Hy=Math.cos(70*so.DEG2RAD),De=new L,fn=2*Math.PI,ie={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Hh=1e-6,Nl=class extends qr{constructor(t,e=null){super(t,e),this.state=ie.NONE,this.target=new L,this.cursor=new L,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Ii.ROTATE,MIDDLE:Ii.DOLLY,RIGHT:Ii.PAN},this.touches={ONE:Li.ROTATE,TWO:Li.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new L,this._lastQuaternion=new yn,this._lastTargetPosition=new L,this._quat=new yn().setFromUnitVectors(t.up,new L(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Hs,this._sphericalDelta=new Hs,this._scale=1,this._panOffset=new L,this._rotateStart=new Mt,this._rotateEnd=new Mt,this._rotateDelta=new Mt,this._panStart=new Mt,this._panEnd=new Mt,this._panDelta=new Mt,this._dollyStart=new Mt,this._dollyEnd=new Mt,this._dollyDelta=new Mt,this._dollyDirection=new L,this._mouse=new Mt,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Xy.bind(this),this._onPointerDown=Wy.bind(this),this._onPointerUp=qy.bind(this),this._onContextMenu=Qy.bind(this),this._onMouseWheel=$y.bind(this),this._onKeyDown=Jy.bind(this),this._onTouchStart=Ky.bind(this),this._onTouchMove=jy.bind(this),this._onMouseDown=Yy.bind(this),this._onMouseMove=Zy.bind(this),this._interceptControlDown=tv.bind(this),this._interceptControlUp=ev.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(t){this._cursorStyle=t,t==="grab"?this.domElement.style.cursor="grab":this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=""}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(wd),this.update(),this.state=ie.NONE}pan(t,e){this._pan(t,e),this.update()}dollyIn(t){this._dollyIn(t),this.update()}dollyOut(t){this._dollyOut(t),this.update()}rotateLeft(t){this._rotateLeft(t),this.update()}rotateUp(t){this._rotateUp(t),this.update()}update(t=null){let e=this.object.position;De.copy(e).sub(this.target),De.applyQuaternion(this._quat),this._spherical.setFromVector3(De),this.autoRotate&&this.state===ie.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(n)&&isFinite(s)&&(n<-Math.PI?n+=fn:n>Math.PI&&(n-=fn),s<-Math.PI?s+=fn:s>Math.PI&&(s-=fn),n<=s?this._spherical.theta=Math.max(n,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+s)/2?Math.max(n,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let o=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=o!=this._spherical.radius}if(De.setFromSpherical(this._spherical),De.applyQuaternion(this._quatInverse),e.copy(this.target).add(De),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let o=null;if(this.object.isPerspectiveCamera){let a=De.length();o=this._clampDistance(a*this._scale);let l=a-o;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),r=!!l}else if(this.object.isOrthographicCamera){let a=new L(this._mouse.x,this._mouse.y,0);a.unproject(this.object);let l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=l!==this.object.zoom;let c=new L(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(a),this.object.updateMatrixWorld(),o=De.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;o!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position):(Dl.origin.copy(this.object.position),Dl.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Dl.direction))<Hy?this.object.lookAt(this.target):(Cd.setFromNormalAndCoplanarPoint(this.object.up,this.target),Dl.intersectPlane(Cd,this.target))))}else if(this.object.isOrthographicCamera){let o=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),o!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>Hh||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Hh||this._lastTargetPosition.distanceToSquared(this.target)>Hh?(this.dispatchEvent(wd),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?fn/60*this.autoRotateSpeed*t:fn/60/60*this.autoRotateSpeed}_getZoomScale(t){let e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){De.setFromMatrixColumn(e,0),De.multiplyScalar(-t),this._panOffset.add(De)}_panUp(t,e){this.screenSpacePanning===!0?De.setFromMatrixColumn(e,1):(De.setFromMatrixColumn(e,0),De.crossVectors(this.object.up,De)),De.multiplyScalar(t),this._panOffset.add(De)}_pan(t,e){let n=this.domElement;if(this.object.isPerspectiveCamera){let s=this.object.position;De.copy(s).sub(this.target);let r=De.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*r/n.clientHeight,this.object.matrix),this._panUp(2*e*r/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),s=t-n.left,r=e-n.top,o=n.width,a=n.height;this._mouse.x=s/o*2-1,this._mouse.y=-(r/a)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let e=this.domElement;this._rotateLeft(fn*this._rotateDelta.x/e.clientHeight),this._rotateUp(fn*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(fn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-fn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(fn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-fn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{let e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._rotateStart.set(n,s)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{let e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panStart.set(n,s)}}_handleTouchStartDolly(t){let e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{let n=this._getSecondPointerPosition(t),s=.5*(t.pageX+n.x),r=.5*(t.pageY+n.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let e=this.domElement;this._rotateLeft(fn*this._rotateDelta.x/e.clientHeight),this._rotateUp(fn*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{let e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panEnd.set(n,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){let e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let o=(t.pageX+e.x)*.5,a=(t.pageY+e.y)*.5;this._updateZoomParameters(o,a)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new Mt,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){let e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){let e=t.deltaMode,n={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function Wy(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i),this._cursorStyle==="grab"&&(this.domElement.style.cursor="grabbing")))}function Xy(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function qy(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Rd),this.state=ie.NONE,this._cursorStyle==="grab"&&(this.domElement.style.cursor="grab");break;case 1:let t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function Yy(i){let t;switch(i.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case Ii.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=ie.DOLLY;break;case Ii.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=ie.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=ie.ROTATE}break;case Ii.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=ie.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=ie.PAN}break;default:this.state=ie.NONE}this.state!==ie.NONE&&this.dispatchEvent(Wh)}function Zy(i){switch(this.state){case ie.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case ie.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case ie.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function $y(i){this.enabled===!1||this.enableZoom===!1||this.state!==ie.NONE||(i.preventDefault(),this.dispatchEvent(Wh),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(Rd))}function Jy(i){this.enabled!==!1&&this._handleKeyDown(i)}function Ky(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case Li.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=ie.TOUCH_ROTATE;break;case Li.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=ie.TOUCH_PAN;break;default:this.state=ie.NONE}break;case 2:switch(this.touches.TWO){case Li.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=ie.TOUCH_DOLLY_PAN;break;case Li.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=ie.TOUCH_DOLLY_ROTATE;break;default:this.state=ie.NONE}break;default:this.state=ie.NONE}this.state!==ie.NONE&&this.dispatchEvent(Wh)}function jy(i){switch(this._trackPointer(i),this.state){case ie.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case ie.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case ie.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case ie.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=ie.NONE}}function Qy(i){this.enabled!==!1&&i.preventDefault()}function tv(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function ev(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}var js=Math.pow(2,-24),lo=Symbol("SKIP_GENERATION"),Ul={strategy:0,maxDepth:40,targetLeafSize:10,useSharedArrayBuffer:!1,setBoundingBox:!0,onProgress:null,indirect:!1,verbose:!0,range:null,[lo]:!1};function le(i,t,e){return e.min.x=t[i],e.min.y=t[i+1],e.min.z=t[i+2],e.max.x=t[i+3],e.max.y=t[i+4],e.max.z=t[i+5],e}function co(i){let t=-1,e=-1/0;for(let n=0;n<3;n++){let s=i[n+3]-i[n];s>e&&(e=s,t=n)}return t}function Xh(i,t){t.set(i)}function qh(i,t,e){let n,s;for(let r=0;r<3;r++){let o=r+3;n=i[r],s=t[r],e[r]=n<s?n:s,n=i[o],s=t[o],e[o]=n>s?n:s}}function ho(i,t,e){for(let n=0;n<3;n++){let s=t[i+2*n],r=t[i+2*n+1],o=s-r,a=s+r;o<e[n]&&(e[n]=o),a>e[n+3]&&(e[n+3]=a)}}function Qs(i){let t=i[3]-i[0],e=i[4]-i[1],n=i[5]-i[2];return 2*(t*e+e*n+n*t)}function Xt(i,t){return t[i+15]===65535}function te(i,t){return t[i+6]}function se(i,t){return t[i+14]}function Kt(i){return i+8}function jt(i,t){let e=t[i+6];return i+e*8}function tr(i,t){return t[i+7]}function Fl(i,t,e,n,s){let r=1/0,o=1/0,a=1/0,l=-1/0,c=-1/0,u=-1/0,f=1/0,h=1/0,d=1/0,g=-1/0,y=-1/0,m=-1/0,p=i.offset||0;for(let M=(t-p)*6,b=(t+e-p)*6;M<b;M+=6){let x=i[M+0],S=i[M+1],T=x-S,w=x+S;T<r&&(r=T),w>l&&(l=w),x<f&&(f=x),x>g&&(g=x);let _=i[M+2],A=i[M+3],C=_-A,P=_+A;C<o&&(o=C),P>c&&(c=P),_<h&&(h=_),_>y&&(y=_);let R=i[M+4],D=i[M+5],O=R-D,N=R+D;O<a&&(a=O),N>u&&(u=N),R<d&&(d=R),R>m&&(m=R)}n[0]=r,n[1]=o,n[2]=a,n[3]=l,n[4]=c,n[5]=u,s[0]=f,s[1]=h,s[2]=d,s[3]=g,s[4]=y,s[5]=m}var fi=32,sv=(i,t)=>i.candidate-t.candidate,Oi=new Array(fi).fill().map(()=>({count:0,bounds:new Float32Array(6),rightCacheBounds:new Float32Array(6),leftCacheBounds:new Float32Array(6),candidate:0})),Bl=new Float32Array(6);function Ld(i,t,e,n,s,r){let o=-1,a=0;if(r===0)o=co(t),o!==-1&&(a=(t[o]+t[o+3])/2);else if(r===1)o=co(i),o!==-1&&(a=rv(e,n,s,o));else if(r===2){let l=Qs(i),c=1.25*s,u=e.offset||0,f=(n-u)*6,h=(n+s-u)*6;for(let d=0;d<3;d++){let g=t[d],p=(t[d+3]-g)/fi;if(s<fi/4){let M=[...Oi];M.length=s;let b=0;for(let S=f;S<h;S+=6,b++){let T=M[b];T.candidate=e[S+2*d],T.count=0;let{bounds:w,leftCacheBounds:_,rightCacheBounds:A}=T;for(let C=0;C<3;C++)A[C]=1/0,A[C+3]=-1/0,_[C]=1/0,_[C+3]=-1/0,w[C]=1/0,w[C+3]=-1/0;ho(S,e,w)}M.sort(sv);let x=s;for(let S=0;S<x;S++){let T=M[S];for(;S+1<x&&M[S+1].candidate===T.candidate;)M.splice(S+1,1),x--}for(let S=f;S<h;S+=6){let T=e[S+2*d];for(let w=0;w<x;w++){let _=M[w];T>=_.candidate?ho(S,e,_.rightCacheBounds):(ho(S,e,_.leftCacheBounds),_.count++)}}for(let S=0;S<x;S++){let T=M[S],w=T.count,_=s-T.count,A=T.leftCacheBounds,C=T.rightCacheBounds,P=0;w!==0&&(P=Qs(A)/l);let R=0;_!==0&&(R=Qs(C)/l);let D=1+1.25*(P*w+R*_);D<c&&(o=d,c=D,a=T.candidate)}}else{for(let x=0;x<fi;x++){let S=Oi[x];S.count=0,S.candidate=g+p+x*p;let T=S.bounds;for(let w=0;w<3;w++)T[w]=1/0,T[w+3]=-1/0}for(let x=f;x<h;x+=6){let w=~~((e[x+2*d]-g)/p);w>=fi&&(w=fi-1);let _=Oi[w];_.count++,ho(x,e,_.bounds)}let M=Oi[fi-1];Xh(M.bounds,M.rightCacheBounds);for(let x=fi-2;x>=0;x--){let S=Oi[x],T=Oi[x+1];qh(S.bounds,T.rightCacheBounds,S.rightCacheBounds)}let b=0;for(let x=0;x<fi-1;x++){let S=Oi[x],T=S.count,w=S.bounds,A=Oi[x+1].rightCacheBounds;T!==0&&(b===0?Xh(w,Bl):qh(w,Bl,Bl)),b+=T;let C=0,P=0;b!==0&&(C=Qs(Bl)/l);let R=s-b;R!==0&&(P=Qs(A)/l);let D=1+1.25*(C*b+P*R);D<c&&(o=d,c=D,a=S.candidate)}}}}else console.warn(`BVH: Invalid build strategy value ${r} used.`);return{axis:o,pos:a}}function rv(i,t,e,n){let s=0,r=i.offset;for(let o=t,a=t+e;o<a;o++)s+=i[(o-r)*6+n*2];return s/e}var er=class{constructor(){this.boundingData=new Float32Array(6)}};function Dd(i,t,e,n,s,r){let o=n,a=n+s-1,l=r.pos,c=r.axis*2,u=e.offset||0;for(;;){for(;o<=a&&e[(o-u)*6+c]<l;)o++;for(;o<=a&&e[(a-u)*6+c]>=l;)a--;if(o<a){for(let f=0;f<t;f++){let h=i[o*t+f];i[o*t+f]=i[a*t+f],i[a*t+f]=h}for(let f=0;f<6;f++){let h=o-u,d=a-u,g=e[h*6+f];e[h*6+f]=e[d*6+f],e[d*6+f]=g}o++,a--}else return o}}var Nd,Ol,Yh,Ud,ov=Math.pow(2,32);function zl(i){return"count"in i?1:1+zl(i.left)+zl(i.right)}function Fd(i,t,e){return Nd=new Float32Array(e),Ol=new Uint32Array(e),Yh=new Uint16Array(e),Ud=new Uint8Array(e),Zh(i,t)}function Zh(i,t){let e=i/4,n=i/2,s="count"in t,r=t.boundingData;for(let o=0;o<6;o++)Nd[e+o]=r[o];if(s)return t.buffer?(Ud.set(new Uint8Array(t.buffer),i),i+t.buffer.byteLength):(Ol[e+6]=t.offset,Yh[n+14]=t.count,Yh[n+15]=65535,i+32);{let{left:o,right:a,splitAxis:l}=t,c=i+32,u=Zh(c,o),f=i/32,d=u/32-f;if(d>ov)throw new Error("MeshBVH: Cannot store relative child node offset greater than 32 bits.");return Ol[e+6]=d,Ol[e+7]=l,Zh(u,a)}}function av(i,t,e,n,s,r){let{maxDepth:o,verbose:a,targetLeafSize:l,_strictLeafSize:c=1/0,strategy:u,onProgress:f}=s,h=i.primitiveBuffer,d=i.primitiveBufferStride,g=new Float32Array(6),y=!1,m=new er;return Fl(t,e,n,m.boundingData,g),M(m,e,n,g),m;function p(b){f&&f((b-r.offset)/r.count)}function M(b,x,S,T=null,w=0){!y&&w>=o&&(y=!0,a&&console.warn(`BVH: Max depth of ${o} reached when generating BVH. Consider increasing maxDepth.`));let _=S>c;if(S<=l&&!_||w>=o)return p(x+S),b.offset=x,b.count=S,b;let A=Ld(b.boundingData,T,t,x,S,u),C=A.axis===-1?-1:Dd(h,d,t,x,S,A);if(A.axis===-1||C===x||C===x+S){if(!_)return p(x+S),b.offset=x,b.count=S,b;A.axis=Math.max(0,co(b.boundingData)),C=x+Math.max(1,Math.floor(S/2))}b.splitAxis=A.axis;let P=new er,R=x,D=C-x;b.left=P,Fl(t,R,D,P.boundingData,g),M(P,R,D,g,w+1);let O=new er,N=C,H=S-D;return b.right=O,Fl(t,N,H,O.boundingData,g),M(O,N,H,g,w+1),b}}function Bd(i,t){let e=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,n=i.getRootRanges(t.range),s=n[0],r=n[n.length-1],o={offset:s.offset,count:r.offset+r.count-s.offset},a=new Float32Array(6*o.count);a.offset=o.offset,i.computePrimitiveBounds(o.offset,o.count,a),i._roots=n.map(l=>{let c=av(i,a,l.offset,l.count,t,o),u=zl(c),f=new e(32*u);return Fd(0,c,f),f})}var zi=class{constructor(t){this._getNewPrimitive=t,this._primitives=[]}getPrimitive(){let t=this._primitives;return t.length===0?this._getNewPrimitive():t.pop()}releasePrimitive(t){this._primitives.push(t)}};var $h=class{constructor(){this.float32Array=null,this.uint16Array=null,this.uint32Array=null;let t=[],e=null;this.setBuffer=n=>{e&&t.push(e),e=n,this.float32Array=new Float32Array(n),this.uint16Array=new Uint16Array(n),this.uint32Array=new Uint32Array(n)},this.clearBuffer=()=>{e=null,this.float32Array=null,this.uint16Array=null,this.uint32Array=null,t.length!==0&&this.setBuffer(t.pop())}}},Zt=new $h;var Vi,ir,nr=[],Vl=new zi(()=>new Jt);function Od(i,t,e,n,s,r){Vi=Vl.getPrimitive(),ir=Vl.getPrimitive(),nr.push(Vi,ir),Zt.setBuffer(i._roots[t]);let o=Jh(0,i.geometry,e,n,s,r);Zt.clearBuffer(),Vl.releasePrimitive(Vi),Vl.releasePrimitive(ir),nr.pop(),nr.pop();let a=nr.length;return a>0&&(ir=nr[a-1],Vi=nr[a-2]),o}function Jh(i,t,e,n,s=null,r=0,o=0){let{float32Array:a,uint16Array:l,uint32Array:c}=Zt,u=i*2;if(Xt(u,l)){let h=te(i,c),d=se(u,l);return le(i,a,Vi),n(h,d,!1,o,r+i/8,Vi)}else{let C=function(R){let{uint16Array:D,uint32Array:O}=Zt,N=R*2;for(;!Xt(N,D);)R=Kt(R),N=R*2;return te(R,O)},P=function(R){let{uint16Array:D,uint32Array:O}=Zt,N=R*2;for(;!Xt(N,D);)R=jt(R,O),N=R*2;return te(R,O)+se(N,D)},h=Kt(i),d=jt(i,c),g=h,y=d,m,p,M,b;if(s&&(M=Vi,b=ir,le(g,a,M),le(y,a,b),m=s(M),p=s(b),p<m)){g=d,y=h;let R=m;m=p,p=R,M=b}M||(M=Vi,le(g,a,M));let x=Xt(g*2,l),S=e(M,x,m,o+1,r+g/8),T;if(S===2){let R=C(g),O=P(g)-R;T=n(R,O,!0,o+1,r+g/8,M)}else T=S&&Jh(g,t,e,n,s,r,o+1);if(T)return!0;b=ir,le(y,a,b);let w=Xt(y*2,l),_=e(b,w,p,o+1,r+y/8),A;if(_===2){let R=C(y),O=P(y)-R;A=n(R,O,!0,o+1,r+y/8,b)}else A=_&&Jh(y,t,e,n,s,r,o+1);return!!A}}var uo=new Zt.constructor,kl=new Zt.constructor,ki=new zi(()=>new Jt),sr=new Jt,rr=new Jt,jh=new Jt,Qh=new Jt,tu=!1;function zd(i,t,e,n){if(tu)throw new Error("MeshBVH: Recursive calls to bvhcast not supported.");tu=!0;let s=i._roots,r=t._roots,o,a=0,l=0,c=new Ft().copy(e).invert();for(let u=0,f=s.length;u<f;u++){uo.setBuffer(s[u]),l=0;let h=ki.getPrimitive();le(0,uo.float32Array,h),h.applyMatrix4(c);for(let d=0,g=r.length;d<g&&(kl.setBuffer(r[d]),o=On(0,0,e,c,n,a,l,0,0,h),kl.clearBuffer(),l+=r[d].byteLength/32,!o);d++);if(ki.releasePrimitive(h),uo.clearBuffer(),a+=s[u].byteLength/32,o)break}return tu=!1,o}function On(i,t,e,n,s,r=0,o=0,a=0,l=0,c=null,u=!1){let f,h;u?(f=kl,h=uo):(f=uo,h=kl);let d=f.float32Array,g=f.uint32Array,y=f.uint16Array,m=h.float32Array,p=h.uint32Array,M=h.uint16Array,b=i*2,x=t*2,S=Xt(b,y),T=Xt(x,M),w=!1;if(T&&S)u?w=s(te(t,p),se(t*2,M),te(i,g),se(i*2,y),l,o+t/8,a,r+i/8):w=s(te(i,g),se(i*2,y),te(t,p),se(t*2,M),a,r+i/8,l,o+t/8);else if(T){let _=ki.getPrimitive();le(t,m,_),_.applyMatrix4(e);let A=Kt(i),C=jt(i,g);le(A,d,sr),le(C,d,rr);let P=_.intersectsBox(sr),R=_.intersectsBox(rr);w=P&&On(t,A,n,e,s,o,r,l,a+1,_,!u)||R&&On(t,C,n,e,s,o,r,l,a+1,_,!u),ki.releasePrimitive(_)}else{let _=Kt(t),A=jt(t,p);le(_,m,jh),le(A,m,Qh);let C=c.intersectsBox(jh),P=c.intersectsBox(Qh);if(C&&P)w=On(i,_,e,n,s,r,o,a,l+1,c,u)||On(i,A,e,n,s,r,o,a,l+1,c,u);else if(C)if(S)w=On(i,_,e,n,s,r,o,a,l+1,c,u);else{let R=ki.getPrimitive();R.copy(jh).applyMatrix4(e);let D=Kt(i),O=jt(i,g);le(D,d,sr),le(O,d,rr);let N=R.intersectsBox(sr),H=R.intersectsBox(rr);w=N&&On(_,D,n,e,s,o,r,l,a+1,R,!u)||H&&On(_,O,n,e,s,o,r,l,a+1,R,!u),ki.releasePrimitive(R)}else if(P)if(S)w=On(i,A,e,n,s,r,o,a,l+1,c,u);else{let R=ki.getPrimitive();R.copy(Qh).applyMatrix4(e);let D=Kt(i),O=jt(i,g);le(D,d,sr),le(O,d,rr);let N=R.intersectsBox(sr),H=R.intersectsBox(rr);w=N&&On(A,D,n,e,s,o,r,l,a+1,R,!u)||H&&On(A,O,n,e,s,o,r,l,a+1,R,!u),ki.releasePrimitive(R)}}return w}var Gl=new class{constructor(){let i=null,t=null,e=null,n=!1;this.root=null,this.buffer=null,this.uint32Array=null,this.uint16Array=null,this.setBVH=(r,o)=>{if(n)throw new Error("BVHTraversalHelper: cannot call setBVH during an active traversal.");this.root=o,this.buffer=i=r._roots[o],this.uint16Array=e=new Uint16Array(i),this.uint32Array=t=new Uint32Array(i)},this.reset=()=>{this.root=null,this.buffer=i=null,this.uint16Array=e=null,this.uint32Array=t=null},this.getRangeStart=r=>{let o=r*2;for(;!Xt(o,e);)r=Kt(r),o=r*2;return te(r,t)},this.getRangeEnd=r=>{let o=r*2;for(;!Xt(o,e);)r=jt(r,t),o=r*2;return te(r,t)+se(o,e)};let s=(r,o,a)=>{let l=o*2,c=Xt(l,e);if(!r(a,c,o)&&!c){let f=Kt(o),h=jt(o,t);s(r,f,a+1),s(r,h,a+1)}};this.traverseBuffer=r=>{if(n)throw new Error("BVHTraversalHelper: cannot start a traversal during an active traversal.");n=!0;try{s(r,0,0)}finally{n=!1}},this.traverse=r=>{this.traverseBuffer((o,a,l)=>{if(a){let c=l*2,u=t[l+6],f=e[c+14];return r(o,a,new Float32Array(i,l*4,6),u,f)}else{let c=tr(l,t);return r(o,a,new Float32Array(i,l*4,6),c)}})}}};var Vd=new Jt,or=new Float32Array(6),Hl=class{constructor(){this._roots=null,this.primitiveBuffer=null,this.primitiveBufferStride=null}init(t){t={...Ul,...t},"maxLeafSize"in t&&(console.warn('BVH: "maxLeafSize" option has been deprecated. Use "targetLeafSize", instead.'),t={...t,targetLeafSize:t.maxLeafSize}),Bd(this,t)}getRootRanges(){throw new Error("BVH: getRootRanges() not implemented")}writePrimitiveBounds(){throw new Error("BVH: writePrimitiveBounds() not implemented")}writePrimitiveRangeBounds(t,e,n,s){let r=1/0,o=1/0,a=1/0,l=-1/0,c=-1/0,u=-1/0;for(let f=t,h=t+e;f<h;f++){this.writePrimitiveBounds(f,or,0);let[d,g,y,m,p,M]=or;d<r&&(r=d),m>l&&(l=m),g<o&&(o=g),p>c&&(c=p),y<a&&(a=y),M>u&&(u=M)}return n[s+0]=r,n[s+1]=o,n[s+2]=a,n[s+3]=l,n[s+4]=c,n[s+5]=u,n}computePrimitiveBounds(t,e,n){let s=n.offset||0;for(let r=t,o=t+e;r<o;r++){this.writePrimitiveBounds(r,or,0);let[a,l,c,u,f,h]=or,d=(a+u)/2,g=(l+f)/2,y=(c+h)/2,m=(u-a)/2,p=(f-l)/2,M=(h-c)/2,b=(r-s)*6;n[b+0]=d,n[b+1]=m+(Math.abs(d)+m)*js,n[b+2]=g,n[b+3]=p+(Math.abs(g)+p)*js,n[b+4]=y,n[b+5]=M+(Math.abs(y)+M)*js}return n}shiftPrimitiveOffsets(t){let e=this._indirectBuffer;if(e)for(let n=0,s=e.length;n<s;n++)e[n]+=t;else{let n=this._roots;for(let s=0;s<n.length;s++){let r=n[s],o=new Uint32Array(r),a=new Uint16Array(r),l=r.byteLength/32;for(let c=0;c<l;c++){let u=8*c,f=2*u;Xt(f,a)&&(o[u+6]+=t)}}}}traverse(t,e=0){Gl.setBVH(this,e),Gl.traverse(t),Gl.reset()}refit(){let t=this._roots;for(let e=0,n=t.length;e<n;e++){let s=t[e],r=new Uint32Array(s),o=new Uint16Array(s),a=new Float32Array(s),l=s.byteLength/32;for(let c=l-1;c>=0;c--){let u=c*8,f=u*2;if(Xt(f,o)){let d=te(u,r),g=se(f,o);this.writePrimitiveRangeBounds(d,g,or,0),a.set(or,u)}else{let d=Kt(u),g=jt(u,r);for(let y=0;y<3;y++){let m=a[d+y],p=a[d+y+3],M=a[g+y],b=a[g+y+3];a[u+y]=m<M?m:M,a[u+y+3]=p>b?p:b}}}}}getBoundingBox(t){return t.makeEmpty(),this._roots.forEach(n=>{le(0,new Float32Array(n),Vd),t.union(Vd)}),t}shapecast(t){let{boundsTraverseOrder:e,intersectsBounds:n,intersectsRange:s,intersectsPrimitive:r,scratchPrimitive:o,iterate:a}=t;if(s&&r){let f=s;s=(h,d,g,y,m)=>f(h,d,g,y,m)?!0:a(h,d,this,r,g,y,o)}else s||(r?s=(f,h,d,g)=>a(f,h,this,r,d,g,o):s=(f,h,d)=>d);let l=!1,c=0,u=this._roots;for(let f=0,h=u.length;f<h;f++){let d=u[f];if(l=Od(this,f,n,s,e,c),l)break;c+=d.byteLength/32}return l}bvhcast(t,e,n){let{intersectsRanges:s}=n;return zd(this,t,e,s)}};function kd(){return typeof SharedArrayBuffer<"u"}function eu(i){return i.index?i.index.count:i.attributes.position.count}function Gi(i){return eu(i)/3}function cv(i,t=ArrayBuffer){return i>65535?new Uint32Array(new t(4*i)):new Uint16Array(new t(2*i))}function Gd(i,t){if(!i.index){let e=i.attributes.position.count,n=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,s=cv(e,n);i.setIndex(new fe(s,1));for(let r=0;r<e;r++)s[r]=r}}function hv(i,t,e){let n=eu(i)/e,s=t||i.drawRange,r=s.start/e,o=(s.start+s.count)/e,a=Math.max(0,r),l=Math.min(n,o)-a;return{offset:Math.floor(a),count:Math.floor(l)}}function uv(i,t){return i.groups.map(e=>({offset:e.start/t,count:e.count/t}))}function nu(i,t,e){let n=hv(i,t,e),s=uv(i,e);if(!s.length)return[n];let r=[],o=n.offset,a=n.offset+n.count,l=eu(i)/e,c=[];for(let h of s){let{offset:d,count:g}=h,y=d,m=isFinite(g)?g:l-d,p=d+m;y<a&&p>o&&(c.push({pos:Math.max(o,y),isStart:!0}),c.push({pos:Math.min(a,p),isStart:!1}))}c.sort((h,d)=>h.pos!==d.pos?h.pos-d.pos:h.type==="end"?-1:1);let u=0,f=null;for(let h of c){let d=h.pos;u!==0&&d!==f&&r.push({offset:f,count:d-f}),u+=h.isStart?1:-1,f=d}return r}function fv(i,t){let e=i[i.length-1],n=e.offset+e.count>2**16,s=i.reduce((c,u)=>c+u.count,0),r=n?4:2,o=t?new SharedArrayBuffer(s*r):new ArrayBuffer(s*r),a=n?new Uint32Array(o):new Uint16Array(o),l=0;for(let c=0;c<i.length;c++){let{offset:u,count:f}=i[c];for(let h=0;h<f;h++)a[l+h]=u+h;l+=f}return a}var Wl=class extends Hl{get indirect(){return!!this._indirectBuffer}get primitiveStride(){return null}get primitiveBufferStride(){return this.indirect?1:this.primitiveStride}set primitiveBufferStride(t){}get primitiveBuffer(){return this.indirect?this._indirectBuffer:this.geometry.index.array}set primitiveBuffer(t){}constructor(t,e={}){if(t.isBufferGeometry){if(t.index&&t.index.isInterleavedBufferAttribute)throw new Error("BVH: InterleavedBufferAttribute is not supported for the index attribute.")}else throw new Error("BVH: Only BufferGeometries are supported.");if(e.useSharedArrayBuffer&&!kd())throw new Error("BVH: SharedArrayBuffer is not available.");super(),this.geometry=t,this.resolvePrimitiveIndex=e.indirect?n=>this._indirectBuffer[n]:n=>n,this.primitiveBuffer=null,this.primitiveBufferStride=null,this._indirectBuffer=null,e={...Ul,...e},e[lo]||this.init(e)}init(t){let{geometry:e,primitiveStride:n}=this;if(t.indirect){let s=nu(e,t.range,n),r=fv(s,t.useSharedArrayBuffer);this._indirectBuffer=r}else Gd(e,t);super.init(t),!e.boundingBox&&t.setBoundingBox&&(e.boundingBox=this.getBoundingBox(new Jt))}getRootRanges(t){return this.indirect?[{offset:0,count:this._indirectBuffer.length}]:nu(this.geometry,t,this.primitiveStride)}raycastObject3D(){throw new Error("BVH: raycastObject3D() not implemented")}};var bn=class{constructor(){this.min=1/0,this.max=-1/0}setFromPointsField(t,e){let n=1/0,s=-1/0;for(let r=0,o=t.length;r<o;r++){let l=t[r][e];n=l<n?l:n,s=l>s?l:s}this.min=n,this.max=s}setFromPoints(t,e){let n=1/0,s=-1/0;for(let r=0,o=e.length;r<o;r++){let a=e[r],l=t.dot(a);n=l<n?l:n,s=l>s?l:s}this.min=n,this.max=s}isSeparated(t){return this.min>t.max||t.min>this.max}};bn.prototype.setFromBox=(function(){let i=new L;return function(e,n){let s=n.min,r=n.max,o=1/0,a=-1/0;for(let l=0;l<=1;l++)for(let c=0;c<=1;c++)for(let u=0;u<=1;u++){i.x=s.x*l+r.x*(1-l),i.y=s.y*c+r.y*(1-c),i.z=s.z*u+r.z*(1-u);let f=e.dot(i);o=Math.min(f,o),a=Math.max(f,a)}this.min=o,this.max=a}})();var dv=(function(){let i=new L,t=new L,e=new L;return function(s,r,o){let a=s.start,l=i,c=r.start,u=t;e.subVectors(a,c),i.subVectors(s.end,s.start),t.subVectors(r.end,r.start);let f=e.dot(u),h=u.dot(l),d=u.dot(u),g=e.dot(l),m=l.dot(l)*d-h*h,p,M;m!==0?p=(f*h-g*d)/m:p=0,M=(f+p*h)/d,o.x=p,o.y=M}})(),fo=(function(){let i=new Mt,t=new L,e=new L;return function(s,r,o,a){dv(s,r,i);let l=i.x,c=i.y;if(l>=0&&l<=1&&c>=0&&c<=1){s.at(l,o),r.at(c,a);return}else if(l>=0&&l<=1){c<0?r.at(0,a):r.at(1,a),s.closestPointToPoint(a,!0,o);return}else if(c>=0&&c<=1){l<0?s.at(0,o):s.at(1,o),r.closestPointToPoint(o,!0,a);return}else{let u;l<0?u=s.start:u=s.end;let f;c<0?f=r.start:f=r.end;let h=t,d=e;if(s.closestPointToPoint(f,!0,t),r.closestPointToPoint(u,!0,e),h.distanceToSquared(f)<=d.distanceToSquared(u)){o.copy(h),a.copy(f);return}else{o.copy(u),a.copy(d);return}}}})(),Hd=(function(){let i=new L,t=new L,e=new $e,n=new sn;return function(r,o){let{radius:a,center:l}=r,{a:c,b:u,c:f}=o;if(n.start=c,n.end=u,n.closestPointToPoint(l,!0,i).distanceTo(l)<=a||(n.start=c,n.end=f,n.closestPointToPoint(l,!0,i).distanceTo(l)<=a)||(n.start=u,n.end=f,n.closestPointToPoint(l,!0,i).distanceTo(l)<=a))return!0;let y=o.getPlane(e);if(Math.abs(y.distanceToPoint(l))<=a){let p=y.projectPoint(l,t);if(o.containsPoint(p))return!0}return!1}})();var pv=["x","y","z"],di=1e-15,Wd=di*di;function Cn(i){return Math.abs(i)<di}var He=class extends ze{constructor(...t){super(...t),this.isExtendedTriangle=!0,this.satAxes=new Array(4).fill().map(()=>new L),this.satBounds=new Array(4).fill().map(()=>new bn),this.points=[this.a,this.b,this.c],this.plane=new $e,this.isDegenerateIntoSegment=!1,this.isDegenerateIntoPoint=!1,this.degenerateSegment=new sn,this.needsUpdate=!0}intersectsSphere(t){return Hd(t,this)}update(){let t=this.a,e=this.b,n=this.c,s=this.points,r=this.satAxes,o=this.satBounds,a=r[0],l=o[0];this.getNormal(a),l.setFromPoints(a,s);let c=r[1],u=o[1];c.subVectors(t,e),u.setFromPoints(c,s);let f=r[2],h=o[2];f.subVectors(e,n),h.setFromPoints(f,s);let d=r[3],g=o[3];d.subVectors(n,t),g.setFromPoints(d,s);let y=c.length(),m=f.length(),p=d.length();this.isDegenerateIntoPoint=!1,this.isDegenerateIntoSegment=!1,y<di?m<di||p<di?this.isDegenerateIntoPoint=!0:(this.isDegenerateIntoSegment=!0,this.degenerateSegment.start.copy(t),this.degenerateSegment.end.copy(n)):m<di?p<di?this.isDegenerateIntoPoint=!0:(this.isDegenerateIntoSegment=!0,this.degenerateSegment.start.copy(e),this.degenerateSegment.end.copy(t)):p<di&&(this.isDegenerateIntoSegment=!0,this.degenerateSegment.start.copy(n),this.degenerateSegment.end.copy(e)),this.plane.setFromNormalAndCoplanarPoint(a,t),this.needsUpdate=!1}};He.prototype.closestPointToSegment=(function(){let i=new L,t=new L,e=new sn;return function(s,r=null,o=null){let{start:a,end:l}=s,c=this.points,u,f=1/0;for(let h=0;h<3;h++){let d=(h+1)%3;e.start.copy(c[h]),e.end.copy(c[d]),fo(e,s,i,t),u=i.distanceToSquared(t),u<f&&(f=u,r&&r.copy(i),o&&o.copy(t))}return this.closestPointToPoint(a,i),u=a.distanceToSquared(i),u<f&&(f=u,r&&r.copy(i),o&&o.copy(a)),this.closestPointToPoint(l,i),u=l.distanceToSquared(i),u<f&&(f=u,r&&r.copy(i),o&&o.copy(l)),Math.sqrt(f)}})();He.prototype.intersectsTriangle=(function(){let i=new He,t=new bn,e=new bn,n=new L,s=new L,r=new L,o=new L,a=new sn,l=new sn,c=new L,u=new Mt,f=new Mt;function h(b,x,S,T){let w=n;!b.isDegenerateIntoPoint&&!b.isDegenerateIntoSegment?w.copy(b.plane.normal):w.copy(x.plane.normal);let _=b.satBounds,A=b.satAxes;for(let R=1;R<4;R++){let D=_[R],O=A[R];if(t.setFromPoints(O,x.points),D.isSeparated(t)||(o.copy(w).cross(O),t.setFromPoints(o,b.points),e.setFromPoints(o,x.points),t.isSeparated(e)))return!1}let C=x.satBounds,P=x.satAxes;for(let R=1;R<4;R++){let D=C[R],O=P[R];if(t.setFromPoints(O,b.points),D.isSeparated(t)||(o.crossVectors(w,O),t.setFromPoints(o,b.points),e.setFromPoints(o,x.points),t.isSeparated(e)))return!1}return S&&(T||console.warn("ExtendedTriangle.intersectsTriangle: Triangles are coplanar which does not support an output edge. Setting edge to 0, 0, 0."),S.start.set(0,0,0),S.end.set(0,0,0)),!0}function d(b,x,S,T,w,_,A,C,P,R,D){let O=A/(A-C);R.x=T+(w-T)*O,D.start.subVectors(x,b).multiplyScalar(O).add(b),O=A/(A-P),R.y=T+(_-T)*O,D.end.subVectors(S,b).multiplyScalar(O).add(b)}function g(b,x,S,T,w,_,A,C,P,R,D){if(w>0)d(b.c,b.a,b.b,T,x,S,P,A,C,R,D);else if(_>0)d(b.b,b.a,b.c,S,x,T,C,A,P,R,D);else if(C*P>0||A!=0)d(b.a,b.b,b.c,x,S,T,A,C,P,R,D);else if(C!=0)d(b.b,b.a,b.c,S,x,T,C,A,P,R,D);else if(P!=0)d(b.c,b.a,b.b,T,x,S,P,A,C,R,D);else return!0;return!1}function y(b,x,S,T){let w=x.degenerateSegment,_=b.plane.distanceToPoint(w.start),A=b.plane.distanceToPoint(w.end);return Cn(_)?Cn(A)?h(b,x,S,T):(S&&(S.start.copy(w.start),S.end.copy(w.start)),b.containsPoint(w.start)):Cn(A)?(S&&(S.start.copy(w.end),S.end.copy(w.end)),b.containsPoint(w.end)):b.plane.intersectLine(w,n)!=null?(S&&(S.start.copy(n),S.end.copy(n)),b.containsPoint(n)):!1}function m(b,x,S){let T=x.a;return Cn(b.plane.distanceToPoint(T))&&b.containsPoint(T)?(S&&(S.start.copy(T),S.end.copy(T)),!0):!1}function p(b,x,S){let T=b.degenerateSegment,w=x.a;return T.closestPointToPoint(w,!0,n),w.distanceToSquared(n)<Wd?(S&&(S.start.copy(w),S.end.copy(w)),!0):!1}function M(b,x,S,T){if(b.isDegenerateIntoSegment)if(x.isDegenerateIntoSegment){let w=b.degenerateSegment,_=x.degenerateSegment,A=s,C=r;w.delta(A),_.delta(C);let P=n.subVectors(_.start,w.start),R=A.x*C.y-A.y*C.x;if(Cn(R))return!1;let D=(P.x*C.y-P.y*C.x)/R,O=-(A.x*P.y-A.y*P.x)/R;if(D<0||D>1||O<0||O>1)return!1;let N=w.start.z+A.z*D,H=_.start.z+C.z*O;return Cn(N-H)?(S&&(S.start.copy(w.start).addScaledVector(A,D),S.end.copy(w.start).addScaledVector(A,D)),!0):!1}else return x.isDegenerateIntoPoint?p(b,x,S):y(x,b,S,T);else{if(b.isDegenerateIntoPoint)return x.isDegenerateIntoPoint?x.a.distanceToSquared(b.a)<Wd?(S&&(S.start.copy(b.a),S.end.copy(b.a)),!0):!1:x.isDegenerateIntoSegment?p(x,b,S):m(x,b,S);if(x.isDegenerateIntoPoint)return m(b,x,S);if(x.isDegenerateIntoSegment)return y(b,x,S,T)}}return function(x,S=null,T=!1){this.needsUpdate&&this.update(),x.isExtendedTriangle?x.needsUpdate&&x.update():(i.copy(x),i.update(),x=i);let w=M(this,x,S,T);if(w!==void 0)return w;let _=this.plane,A=x.plane,C=A.distanceToPoint(this.a),P=A.distanceToPoint(this.b),R=A.distanceToPoint(this.c);Cn(C)&&(C=0),Cn(P)&&(P=0),Cn(R)&&(R=0);let D=C*P,O=C*R;if(D>0&&O>0)return!1;let N=_.distanceToPoint(x.a),H=_.distanceToPoint(x.b),X=_.distanceToPoint(x.c);Cn(N)&&(N=0),Cn(H)&&(H=0),Cn(X)&&(X=0);let K=N*H,tt=N*X;if(K>0&&tt>0)return!1;s.copy(_.normal),r.copy(A.normal);let rt=s.cross(r),ht=0,gt=Math.abs(rt.x),Wt=Math.abs(rt.y);Wt>gt&&(gt=Wt,ht=1),Math.abs(rt.z)>gt&&(ht=2);let kt=pv[ht],$=this.a[kt],it=this.b[kt],et=this.c[kt],It=x.a[kt],Nt=x.b[kt],Ct=x.c[kt];if(g(this,$,it,et,D,O,C,P,R,u,a))return h(this,x,S,T);if(g(x,It,Nt,Ct,K,tt,N,H,X,f,l))return h(this,x,S,T);if(u.y<u.x){let de=u.y;u.y=u.x,u.x=de,c.copy(a.start),a.start.copy(a.end),a.end.copy(c)}if(f.y<f.x){let de=f.y;f.y=f.x,f.x=de,c.copy(l.start),l.start.copy(l.end),l.end.copy(c)}return u.y<f.x||f.y<u.x?!1:(S&&(f.x>u.x?S.start.copy(l.start):S.start.copy(a.start),f.y<u.y?S.end.copy(l.end):S.end.copy(a.end)),!0)}})();He.prototype.distanceToPoint=(function(){let i=new L;return function(e){return this.closestPointToPoint(e,i),e.distanceTo(i)}})();He.prototype.distanceToTriangle=(function(){let i=new L,t=new L,e=["a","b","c"],n=new sn,s=new sn;return function(o,a=null,l=null){let c=a||l?n:null;if(this.intersectsTriangle(o,c,!0))return(a||l)&&(a&&c.getCenter(a),l&&c.getCenter(l)),0;let u=1/0;for(let f=0;f<3;f++){let h,d=e[f],g=o[d];this.closestPointToPoint(g,i),h=g.distanceToSquared(i),h<u&&(u=h,a&&a.copy(i),l&&l.copy(g));let y=this[d];o.closestPointToPoint(y,i),h=y.distanceToSquared(i),h<u&&(u=h,a&&a.copy(y),l&&l.copy(i))}for(let f=0;f<3;f++){let h=e[f],d=e[(f+1)%3];n.set(this[h],this[d]);for(let g=0;g<3;g++){let y=e[g],m=e[(g+1)%3];s.set(o[y],o[m]),fo(n,s,i,t);let p=i.distanceToSquared(t);p<u&&(u=p,a&&a.copy(i),l&&l.copy(t))}}return Math.sqrt(u)}})();var Me=class{constructor(t,e,n){this.isOrientedBox=!0,this.min=new L,this.max=new L,this.matrix=new Ft,this.invMatrix=new Ft,this.points=new Array(8).fill().map(()=>new L),this.satAxes=new Array(3).fill().map(()=>new L),this.satBounds=new Array(3).fill().map(()=>new bn),this.alignedSatBounds=new Array(3).fill().map(()=>new bn),this.needsUpdate=!1,t&&this.min.copy(t),e&&this.max.copy(e),n&&this.matrix.copy(n)}set(t,e,n){this.min.copy(t),this.max.copy(e),this.matrix.copy(n),this.needsUpdate=!0}copy(t){this.min.copy(t.min),this.max.copy(t.max),this.matrix.copy(t.matrix),this.needsUpdate=!0}};Me.prototype.update=(function(){return function(){let t=this.matrix,e=this.min,n=this.max,s=this.points;for(let c=0;c<=1;c++)for(let u=0;u<=1;u++)for(let f=0;f<=1;f++){let h=1*c|2*u|4*f,d=s[h];d.x=c?n.x:e.x,d.y=u?n.y:e.y,d.z=f?n.z:e.z,d.applyMatrix4(t)}let r=this.satBounds,o=this.satAxes,a=s[0];for(let c=0;c<3;c++){let u=o[c],f=r[c],h=1<<c,d=s[h];u.subVectors(a,d),f.setFromPoints(u,s)}let l=this.alignedSatBounds;l[0].setFromPointsField(s,"x"),l[1].setFromPointsField(s,"y"),l[2].setFromPointsField(s,"z"),this.invMatrix.copy(this.matrix).invert(),this.needsUpdate=!1}})();Me.prototype.intersectsBox=(function(){let i=new bn;return function(e){this.needsUpdate&&this.update();let n=e.min,s=e.max,r=this.satBounds,o=this.satAxes,a=this.alignedSatBounds;if(i.min=n.x,i.max=s.x,a[0].isSeparated(i)||(i.min=n.y,i.max=s.y,a[1].isSeparated(i))||(i.min=n.z,i.max=s.z,a[2].isSeparated(i)))return!1;for(let l=0;l<3;l++){let c=o[l],u=r[l];if(i.setFromBox(c,e),u.isSeparated(i))return!1}return!0}})();Me.prototype.intersectsTriangle=(function(){let i=new He,t=new Array(3),e=new bn,n=new bn,s=new L;return function(o){this.needsUpdate&&this.update(),o.isExtendedTriangle?o.needsUpdate&&o.update():(i.copy(o),i.update(),o=i);let a=this.satBounds,l=this.satAxes;t[0]=o.a,t[1]=o.b,t[2]=o.c;for(let h=0;h<3;h++){let d=a[h],g=l[h];if(e.setFromPoints(g,t),d.isSeparated(e))return!1}let c=o.satBounds,u=o.satAxes,f=this.points;for(let h=0;h<3;h++){let d=c[h],g=u[h];if(e.setFromPoints(g,f),d.isSeparated(e))return!1}for(let h=0;h<3;h++){let d=l[h];for(let g=0;g<4;g++){let y=u[g];if(s.crossVectors(d,y),e.setFromPoints(s,t),n.setFromPoints(s,f),e.isSeparated(n))return!1}}return!0}})();Me.prototype.closestPointToPoint=(function(){return function(t,e){return this.needsUpdate&&this.update(),e.copy(t).applyMatrix4(this.invMatrix).clamp(this.min,this.max).applyMatrix4(this.matrix),e}})();Me.prototype.distanceToPoint=(function(){let i=new L;return function(e){return this.closestPointToPoint(e,i),e.distanceTo(i)}})();Me.prototype.distanceToBox=(function(){let i=["x","y","z"],t=new Array(12).fill().map(()=>new sn),e=new Array(12).fill().map(()=>new sn),n=new L,s=new L;return function(o,a=0,l=null,c=null){if(this.needsUpdate&&this.update(),this.intersectsBox(o))return(l||c)&&(o.getCenter(s),this.closestPointToPoint(s,n),o.closestPointToPoint(n,s),l&&l.copy(n),c&&c.copy(s)),0;let u=a*a,f=o.min,h=o.max,d=this.points,g=1/0;for(let m=0;m<8;m++){let p=d[m];s.copy(p).clamp(f,h);let M=p.distanceToSquared(s);if(M<g&&(g=M,l&&l.copy(p),c&&c.copy(s),M<u))return Math.sqrt(M)}let y=0;for(let m=0;m<3;m++)for(let p=0;p<=1;p++)for(let M=0;M<=1;M++){let b=(m+1)%3,x=(m+2)%3,S=p<<b|M<<x,T=1<<m|p<<b|M<<x,w=d[S],_=d[T];t[y].set(w,_);let C=i[m],P=i[b],R=i[x],D=e[y],O=D.start,N=D.end;O[C]=f[C],O[P]=p?f[P]:h[P],O[R]=M?f[R]:h[P],N[C]=h[C],N[P]=p?f[P]:h[P],N[R]=M?f[R]:h[P],y++}for(let m=0;m<=1;m++)for(let p=0;p<=1;p++)for(let M=0;M<=1;M++){s.x=m?h.x:f.x,s.y=p?h.y:f.y,s.z=M?h.z:f.z,this.closestPointToPoint(s,n);let b=s.distanceToSquared(n);if(b<g&&(g=b,l&&l.copy(n),c&&c.copy(s),b<u))return Math.sqrt(b)}for(let m=0;m<12;m++){let p=t[m];for(let M=0;M<12;M++){let b=e[M];fo(p,b,n,s);let x=n.distanceToSquared(s);if(x<g&&(g=x,l&&l.copy(n),c&&c.copy(s),x<u))return Math.sqrt(x)}}return Math.sqrt(g)}})();var iu=class extends zi{constructor(){super(()=>new He)}},rn=new iu;var po=new L,su=new L;function Xd(i,t,e={},n=0,s=1/0){let r=n*n,o=s*s,a=1/0,l=null;if(i.shapecast({boundsTraverseOrder:u=>(po.copy(t).clamp(u.min,u.max),po.distanceToSquared(t)),intersectsBounds:(u,f,h)=>h<a&&h<o,intersectsTriangle:(u,f)=>{u.closestPointToPoint(t,po);let h=t.distanceToSquared(po);return h<a&&(su.copy(po),a=h,l=f),h<r}}),a===1/0)return null;let c=Math.sqrt(a);return e.point?e.point.copy(su):e.point=su.clone(),e.distance=c,e.faceIndex=l,e}var Xl=parseInt("185")>=169,mv=parseInt("185")<=161,cs=new L,hs=new L,us=new L,ql=new Mt,Yl=new Mt,Zl=new Mt,qd=new L,Yd=new L,Zd=new L,mo=new L;function gv(i,t,e,n,s,r,o,a){let l;if(r===Ge?l=i.intersectTriangle(n,e,t,!0,s):l=i.intersectTriangle(t,e,n,r!==Ke,s),l===null)return null;let c=i.origin.distanceTo(s);return c<o||c>a?null:{distance:c,point:s.clone()}}function $d(i,t,e,n,s,r,o,a,l,c,u){cs.fromBufferAttribute(t,r),hs.fromBufferAttribute(t,o),us.fromBufferAttribute(t,a);let f=gv(i,cs,hs,us,mo,l,c,u);if(f){if(n){ql.fromBufferAttribute(n,r),Yl.fromBufferAttribute(n,o),Zl.fromBufferAttribute(n,a),f.uv=new Mt;let d=ze.getInterpolation(mo,cs,hs,us,ql,Yl,Zl,f.uv);Xl||(f.uv=d)}if(s){ql.fromBufferAttribute(s,r),Yl.fromBufferAttribute(s,o),Zl.fromBufferAttribute(s,a),f.uv1=new Mt;let d=ze.getInterpolation(mo,cs,hs,us,ql,Yl,Zl,f.uv1);Xl||(f.uv1=d),mv&&(f.uv2=f.uv1)}if(e){qd.fromBufferAttribute(e,r),Yd.fromBufferAttribute(e,o),Zd.fromBufferAttribute(e,a),f.normal=new L;let d=ze.getInterpolation(mo,cs,hs,us,qd,Yd,Zd,f.normal);f.normal.dot(i.direction)>0&&f.normal.multiplyScalar(-1),Xl||(f.normal=d)}let h={a:r,b:o,c:a,normal:new L,materialIndex:0};if(ze.getNormal(cs,hs,us,h.normal),f.face=h,f.faceIndex=r,Xl){let d=new L;ze.getBarycoord(mo,cs,hs,us,d),f.barycoord=d}}return f}function Jd(i){return i&&i.isMaterial?i.side:i}function ar(i,t,e,n,s,r,o){let a=n*3,l=a+0,c=a+1,u=a+2,{index:f,groups:h}=i;i.index&&(l=f.getX(l),c=f.getX(c),u=f.getX(u));let{position:d,normal:g,uv:y,uv1:m}=i.attributes;if(Array.isArray(t)){let p=n*3;for(let M=0,b=h.length;M<b;M++){let{start:x,count:S,materialIndex:T}=h[M];if(p>=x&&p<x+S){let w=Jd(t[T]),_=$d(e,d,g,y,m,l,c,u,w,r,o);if(_)if(_.faceIndex=n,_.face.materialIndex=T,s)s.push(_);else return _}}}else{let p=Jd(t),M=$d(e,d,g,y,m,l,c,u,p,r,o);if(M)if(M.faceIndex=n,M.face.materialIndex=0,s)s.push(M);else return M}return null}function ce(i,t,e,n){let s=i.a,r=i.b,o=i.c,a=t,l=t+1,c=t+2;e&&(a=e.getX(a),l=e.getX(l),c=e.getX(c)),s.x=n.getX(a),s.y=n.getY(a),s.z=n.getZ(a),r.x=n.getX(l),r.y=n.getY(l),r.z=n.getZ(l),o.x=n.getX(c),o.y=n.getY(c),o.z=n.getZ(c)}function Kd(i,t,e,n,s,r,o,a){let{geometry:l,_indirectBuffer:c}=i;for(let u=n,f=n+s;u<f;u++)ar(l,t,e,u,r,o,a)}function jd(i,t,e,n,s,r,o){let{geometry:a,_indirectBuffer:l}=i,c=1/0,u=null;for(let f=n,h=n+s;f<h;f++){let d;d=ar(a,t,e,f,null,r,o),d&&d.distance<c&&(u=d,c=d.distance)}return u}function Qd(i,t,e,n,s,r,o){let{geometry:a}=e,{index:l}=a,c=a.attributes.position;for(let u=i,f=t+i;u<f;u++){let h;if(h=u,ce(o,h*3,l,c),o.needsUpdate=!0,n(o,h,s,r))return!0}return!1}function tp(i,t=null){t&&Array.isArray(t)&&(t=new Set(t));let e=i.geometry,n=e.index?e.index.array:null,s=e.attributes.position,r,o,a,l,c=0,u=i._roots;for(let h=0,d=u.length;h<d;h++)r=u[h],o=new Uint32Array(r),a=new Uint16Array(r),l=new Float32Array(r),f(0,c),c+=r.byteLength;function f(h,d,g=!1){let y=h*2;if(Xt(y,a)){let m=te(h,o),p=se(y,a),M=1/0,b=1/0,x=1/0,S=-1/0,T=-1/0,w=-1/0;for(let _=3*m,A=3*(m+p);_<A;_++){let C=n[_],P=s.getX(C),R=s.getY(C),D=s.getZ(C);P<M&&(M=P),P>S&&(S=P),R<b&&(b=R),R>T&&(T=R),D<x&&(x=D),D>w&&(w=D)}return l[h+0]!==M||l[h+1]!==b||l[h+2]!==x||l[h+3]!==S||l[h+4]!==T||l[h+5]!==w?(l[h+0]=M,l[h+1]=b,l[h+2]=x,l[h+3]=S,l[h+4]=T,l[h+5]=w,!0):!1}else{let m=Kt(h),p=jt(h,o),M=g,b=!1,x=!1;if(t){if(!M){let C=m/8+d/32,P=p/8+d/32;b=t.has(C),x=t.has(P),M=!b&&!x}}else b=!0,x=!0;let S=M||b,T=M||x,w=!1;S&&(w=f(m,d,M));let _=!1;T&&(_=f(p,d,M));let A=w||_;if(A)for(let C=0;C<3;C++){let P=m+C,R=p+C,D=l[P],O=l[P+3],N=l[R],H=l[R+3];l[h+C]=D<N?D:N,l[h+C+3]=O>H?O:H}return A}}}function Rn(i,t,e,n,s){let r,o,a,l,c,u,f=1/e.direction.x,h=1/e.direction.y,d=1/e.direction.z,g=e.origin.x,y=e.origin.y,m=e.origin.z,p=t[i],M=t[i+3],b=t[i+1],x=t[i+3+1],S=t[i+2],T=t[i+3+2];return f>=0?(r=(p-g)*f,o=(M-g)*f):(r=(M-g)*f,o=(p-g)*f),h>=0?(a=(b-y)*h,l=(x-y)*h):(a=(x-y)*h,l=(b-y)*h),r>l||a>o||((a>r||isNaN(r))&&(r=a),(l<o||isNaN(o))&&(o=l),d>=0?(c=(S-m)*d,u=(T-m)*d):(c=(T-m)*d,u=(S-m)*d),r>u||c>o)?!1:((c>r||r!==r)&&(r=c),(u<o||o!==o)&&(o=u),r<=s&&o>=n)}function ep(i,t,e,n,s,r,o,a){let{geometry:l,_indirectBuffer:c}=i;for(let u=n,f=n+s;u<f;u++){let h=c?c[u]:u;ar(l,t,e,h,r,o,a)}}function np(i,t,e,n,s,r,o){let{geometry:a,_indirectBuffer:l}=i,c=1/0,u=null;for(let f=n,h=n+s;f<h;f++){let d;d=ar(a,t,e,l?l[f]:f,null,r,o),d&&d.distance<c&&(u=d,c=d.distance)}return u}function ip(i,t,e,n,s,r,o){let{geometry:a}=e,{index:l}=a,c=a.attributes.position;for(let u=i,f=t+i;u<f;u++){let h;if(h=e.resolveTriangleIndex(u),ce(o,h*3,l,c),o.needsUpdate=!0,n(o,h,s,r))return!0}return!1}function sp(i,t,e,n,s,r,o){Zt.setBuffer(i._roots[t]),ru(0,i,e,n,s,r,o),Zt.clearBuffer()}function ru(i,t,e,n,s,r,o){let{float32Array:a,uint16Array:l,uint32Array:c}=Zt,u=i*2;if(Xt(u,l)){let h=te(i,c),d=se(u,l);Kd(t,e,n,h,d,s,r,o)}else{let h=Kt(i);Rn(h,a,n,r,o)&&ru(h,t,e,n,s,r,o);let d=jt(i,c);Rn(d,a,n,r,o)&&ru(d,t,e,n,s,r,o)}}var _v=["x","y","z"];function rp(i,t,e,n,s,r){Zt.setBuffer(i._roots[t]);let o=ou(0,i,e,n,s,r);return Zt.clearBuffer(),o}function ou(i,t,e,n,s,r){let{float32Array:o,uint16Array:a,uint32Array:l}=Zt,c=i*2;if(Xt(c,a)){let f=te(i,l),h=se(c,a);return jd(t,e,n,f,h,s,r)}else{let f=tr(i,l),h=_v[f],g=n.direction[h]>=0,y,m;g?(y=Kt(i),m=jt(i,l)):(y=jt(i,l),m=Kt(i));let M=Rn(y,o,n,s,r)?ou(y,t,e,n,s,r):null;if(M){let S=M.point[h];if(g?S<=o[m+f]:S>=o[m+f+3])return M}let x=Rn(m,o,n,s,r)?ou(m,t,e,n,s,r):null;return M&&x?M.distance<=x.distance?M:x:M||x||null}}var $l=new Jt,lr=new He,cr=new He,go=new Ft,op=new Me,Jl=new Me;function ap(i,t,e,n){Zt.setBuffer(i._roots[t]);let s=au(0,i,e,n);return Zt.clearBuffer(),s}function au(i,t,e,n,s=null){let{float32Array:r,uint16Array:o,uint32Array:a}=Zt,l=i*2;if(s===null&&(e.boundingBox||e.computeBoundingBox(),op.set(e.boundingBox.min,e.boundingBox.max,n),s=op),Xt(l,o)){let u=t.geometry,f=u.index,h=u.attributes.position,d=e.index,g=e.attributes.position,y=te(i,a),m=se(l,o);if(go.copy(n).invert(),e.boundsTree)return le(i,r,Jl),Jl.matrix.copy(go),Jl.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:M=>Jl.intersectsBox(M),intersectsTriangle:M=>{M.a.applyMatrix4(n),M.b.applyMatrix4(n),M.c.applyMatrix4(n),M.needsUpdate=!0;for(let b=y*3,x=(m+y)*3;b<x;b+=3)if(ce(cr,b,f,h),cr.needsUpdate=!0,M.intersectsTriangle(cr))return!0;return!1}});{let p=Gi(e);for(let M=y*3,b=(m+y)*3;M<b;M+=3){ce(lr,M,f,h),lr.a.applyMatrix4(go),lr.b.applyMatrix4(go),lr.c.applyMatrix4(go),lr.needsUpdate=!0;for(let x=0,S=p*3;x<S;x+=3)if(ce(cr,x,d,g),cr.needsUpdate=!0,lr.intersectsTriangle(cr))return!0}}}else{let u=Kt(i),f=jt(i,a);return le(u,r,$l),!!(s.intersectsBox($l)&&au(u,t,e,n,s)||(le(f,r,$l),s.intersectsBox($l)&&au(f,t,e,n,s)))}}var Kl=new Ft,lu=new Me,_o=new Me,xv=new L,yv=new L,vv=new L,Mv=new L;function lp(i,t,e,n={},s={},r=0,o=1/0){t.boundingBox||t.computeBoundingBox(),lu.set(t.boundingBox.min,t.boundingBox.max,e),lu.needsUpdate=!0;let a=i.geometry,l=a.attributes.position,c=a.index,u=t.attributes.position,f=t.index,h=rn.getPrimitive(),d=rn.getPrimitive(),g=xv,y=yv,m=null,p=null;s&&(m=vv,p=Mv);let M=1/0,b=null,x=null;return Kl.copy(e).invert(),_o.matrix.copy(Kl),i.shapecast({boundsTraverseOrder:S=>lu.distanceToBox(S),intersectsBounds:(S,T,w)=>w<M&&w<o?(T&&(_o.min.copy(S.min),_o.max.copy(S.max),_o.needsUpdate=!0),!0):!1,intersectsRange:(S,T)=>{if(t.boundsTree)return t.boundsTree.shapecast({boundsTraverseOrder:_=>_o.distanceToBox(_),intersectsBounds:(_,A,C)=>C<M&&C<o,intersectsRange:(_,A)=>{for(let C=_,P=_+A;C<P;C++){ce(d,3*C,f,u),d.a.applyMatrix4(e),d.b.applyMatrix4(e),d.c.applyMatrix4(e),d.needsUpdate=!0;for(let R=S,D=S+T;R<D;R++){ce(h,3*R,c,l),h.needsUpdate=!0;let O=h.distanceToTriangle(d,g,m);if(O<M&&(y.copy(g),p&&p.copy(m),M=O,b=R,x=C),O<r)return!0}}}});{let w=Gi(t);for(let _=0,A=w;_<A;_++){ce(d,3*_,f,u),d.a.applyMatrix4(e),d.b.applyMatrix4(e),d.c.applyMatrix4(e),d.needsUpdate=!0;for(let C=S,P=S+T;C<P;C++){ce(h,3*C,c,l),h.needsUpdate=!0;let R=h.distanceToTriangle(d,g,m);if(R<M&&(y.copy(g),p&&p.copy(m),M=R,b=C,x=_),R<r)return!0}}}}}),rn.releasePrimitive(h),rn.releasePrimitive(d),M===1/0?null:(n.point?n.point.copy(y):n.point=y.clone(),n.distance=M,n.faceIndex=b,s&&(s.point?s.point.copy(p):s.point=p.clone(),s.point.applyMatrix4(Kl),y.applyMatrix4(Kl),s.distance=y.sub(s.point).length(),s.faceIndex=x),n)}function cp(i,t=null){t&&Array.isArray(t)&&(t=new Set(t));let e=i.geometry,n=e.index?e.index.array:null,s=e.attributes.position,r,o,a,l,c=0,u=i._roots;for(let h=0,d=u.length;h<d;h++)r=u[h],o=new Uint32Array(r),a=new Uint16Array(r),l=new Float32Array(r),f(0,c),c+=r.byteLength;function f(h,d,g=!1){let y=h*2;if(Xt(y,a)){let m=te(h,o),p=se(y,a),M=1/0,b=1/0,x=1/0,S=-1/0,T=-1/0,w=-1/0;for(let _=m,A=m+p;_<A;_++){let C=3*i.resolveTriangleIndex(_);for(let P=0;P<3;P++){let R=C+P;R=n?n[R]:R;let D=s.getX(R),O=s.getY(R),N=s.getZ(R);D<M&&(M=D),D>S&&(S=D),O<b&&(b=O),O>T&&(T=O),N<x&&(x=N),N>w&&(w=N)}}return l[h+0]!==M||l[h+1]!==b||l[h+2]!==x||l[h+3]!==S||l[h+4]!==T||l[h+5]!==w?(l[h+0]=M,l[h+1]=b,l[h+2]=x,l[h+3]=S,l[h+4]=T,l[h+5]=w,!0):!1}else{let m=Kt(h),p=jt(h,o),M=g,b=!1,x=!1;if(t){if(!M){let C=m/8+d/32,P=p/8+d/32;b=t.has(C),x=t.has(P),M=!b&&!x}}else b=!0,x=!0;let S=M||b,T=M||x,w=!1;S&&(w=f(m,d,M));let _=!1;T&&(_=f(p,d,M));let A=w||_;if(A)for(let C=0;C<3;C++){let P=m+C,R=p+C,D=l[P],O=l[P+3],N=l[R],H=l[R+3];l[h+C]=D<N?D:N,l[h+C+3]=O>H?O:H}return A}}}function hp(i,t,e,n,s,r,o){Zt.setBuffer(i._roots[t]),cu(0,i,e,n,s,r,o),Zt.clearBuffer()}function cu(i,t,e,n,s,r,o){let{float32Array:a,uint16Array:l,uint32Array:c}=Zt,u=i*2;if(Xt(u,l)){let h=te(i,c),d=se(u,l);ep(t,e,n,h,d,s,r,o)}else{let h=Kt(i);Rn(h,a,n,r,o)&&cu(h,t,e,n,s,r,o);let d=jt(i,c);Rn(d,a,n,r,o)&&cu(d,t,e,n,s,r,o)}}var Sv=["x","y","z"];function up(i,t,e,n,s,r){Zt.setBuffer(i._roots[t]);let o=hu(0,i,e,n,s,r);return Zt.clearBuffer(),o}function hu(i,t,e,n,s,r){let{float32Array:o,uint16Array:a,uint32Array:l}=Zt,c=i*2;if(Xt(c,a)){let f=te(i,l),h=se(c,a);return np(t,e,n,f,h,s,r)}else{let f=tr(i,l),h=Sv[f],g=n.direction[h]>=0,y,m;g?(y=Kt(i),m=jt(i,l)):(y=jt(i,l),m=Kt(i));let M=Rn(y,o,n,s,r)?hu(y,t,e,n,s,r):null;if(M){let S=M.point[h];if(g?S<=o[m+f]:S>=o[m+f+3])return M}let x=Rn(m,o,n,s,r)?hu(m,t,e,n,s,r):null;return M&&x?M.distance<=x.distance?M:x:M||x||null}}var jl=new Jt,hr=new He,ur=new He,xo=new Ft,fp=new Me,Ql=new Me;function dp(i,t,e,n){Zt.setBuffer(i._roots[t]);let s=uu(0,i,e,n);return Zt.clearBuffer(),s}function uu(i,t,e,n,s=null){let{float32Array:r,uint16Array:o,uint32Array:a}=Zt,l=i*2;if(s===null&&(e.boundingBox||e.computeBoundingBox(),fp.set(e.boundingBox.min,e.boundingBox.max,n),s=fp),Xt(l,o)){let u=t.geometry,f=u.index,h=u.attributes.position,d=e.index,g=e.attributes.position,y=te(i,a),m=se(l,o);if(xo.copy(n).invert(),e.boundsTree)return le(i,r,Ql),Ql.matrix.copy(xo),Ql.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:M=>Ql.intersectsBox(M),intersectsTriangle:M=>{M.a.applyMatrix4(n),M.b.applyMatrix4(n),M.c.applyMatrix4(n),M.needsUpdate=!0;for(let b=y,x=m+y;b<x;b++)if(ce(ur,3*t.resolveTriangleIndex(b),f,h),ur.needsUpdate=!0,M.intersectsTriangle(ur))return!0;return!1}});{let p=Gi(e);for(let M=y,b=m+y;M<b;M++){let x=t.resolveTriangleIndex(M);ce(hr,3*x,f,h),hr.a.applyMatrix4(xo),hr.b.applyMatrix4(xo),hr.c.applyMatrix4(xo),hr.needsUpdate=!0;for(let S=0,T=p*3;S<T;S+=3)if(ce(ur,S,d,g),ur.needsUpdate=!0,hr.intersectsTriangle(ur))return!0}}}else{let u=Kt(i),f=jt(i,a);return le(u,r,jl),!!(s.intersectsBox(jl)&&uu(u,t,e,n,s)||(le(f,r,jl),s.intersectsBox(jl)&&uu(f,t,e,n,s)))}}var tc=new Ft,fu=new Me,yo=new Me,bv=new L,Tv=new L,Ev=new L,Av=new L;function pp(i,t,e,n={},s={},r=0,o=1/0){t.boundingBox||t.computeBoundingBox(),fu.set(t.boundingBox.min,t.boundingBox.max,e),fu.needsUpdate=!0;let a=i.geometry,l=a.attributes.position,c=a.index,u=t.attributes.position,f=t.index,h=rn.getPrimitive(),d=rn.getPrimitive(),g=bv,y=Tv,m=null,p=null;s&&(m=Ev,p=Av);let M=1/0,b=null,x=null;return tc.copy(e).invert(),yo.matrix.copy(tc),i.shapecast({boundsTraverseOrder:S=>fu.distanceToBox(S),intersectsBounds:(S,T,w)=>w<M&&w<o?(T&&(yo.min.copy(S.min),yo.max.copy(S.max),yo.needsUpdate=!0),!0):!1,intersectsRange:(S,T)=>{if(t.boundsTree){let w=t.boundsTree;return w.shapecast({boundsTraverseOrder:_=>yo.distanceToBox(_),intersectsBounds:(_,A,C)=>C<M&&C<o,intersectsRange:(_,A)=>{for(let C=_,P=_+A;C<P;C++){let R=w.resolveTriangleIndex(C);ce(d,3*R,f,u),d.a.applyMatrix4(e),d.b.applyMatrix4(e),d.c.applyMatrix4(e),d.needsUpdate=!0;for(let D=S,O=S+T;D<O;D++){let N=i.resolveTriangleIndex(D);ce(h,3*N,c,l),h.needsUpdate=!0;let H=h.distanceToTriangle(d,g,m);if(H<M&&(y.copy(g),p&&p.copy(m),M=H,b=D,x=C),H<r)return!0}}}})}else{let w=Gi(t);for(let _=0,A=w;_<A;_++){ce(d,3*_,f,u),d.a.applyMatrix4(e),d.b.applyMatrix4(e),d.c.applyMatrix4(e),d.needsUpdate=!0;for(let C=S,P=S+T;C<P;C++){let R=i.resolveTriangleIndex(C);ce(h,3*R,c,l),h.needsUpdate=!0;let D=h.distanceToTriangle(d,g,m);if(D<M&&(y.copy(g),p&&p.copy(m),M=D,b=C,x=_),D<r)return!0}}}}}),rn.releasePrimitive(h),rn.releasePrimitive(d),M===1/0?null:(n.point?n.point.copy(y):n.point=y.clone(),n.distance=M,n.faceIndex=b,s&&(s.point?s.point.copy(p):s.point=p.clone(),s.point.applyMatrix4(tc),y.applyMatrix4(tc),s.distance=y.sub(s.point).length(),s.faceIndex=x),n)}function du(i,t,e){return i===null?null:(i.point.applyMatrix4(t.matrixWorld),i.distance=i.point.distanceTo(e.ray.origin),i.object=t,i)}var ec=new Me,nc=new Fn,mp=new L,gp=new Ft,_p=new L,pu=["getX","getY","getZ"],ic=class i extends Wl{static serialize(t,e={}){e={cloneBuffers:!0,...e};let n=t.geometry,s=t._roots,r=t._indirectBuffer,o=n.getIndex(),a={version:1,roots:null,index:null,indirectBuffer:null};return e.cloneBuffers?(a.roots=s.map(l=>l.slice()),a.index=o?o.array.slice():null,a.indirectBuffer=r?r.slice():null):(a.roots=s,a.index=o?o.array:null,a.indirectBuffer=r),a}static deserialize(t,e,n={}){n={setIndex:!0,indirect:!!t.indirectBuffer,...n};let{index:s,roots:r,indirectBuffer:o}=t;t.version||(console.warn("MeshBVH.deserialize: Serialization format has been changed and will be fixed up. It is recommended to regenerate any stored serialized data."),l(r));let a=new i(e,{...n,[lo]:!0});if(a._roots=r,a._indirectBuffer=o||null,n.setIndex){let c=e.getIndex();if(c===null){let u=new fe(t.index,1,!1);e.setIndex(u)}else c.array!==s&&(c.array.set(s),c.needsUpdate=!0)}return a;function l(c){for(let u=0;u<c.length;u++){let f=c[u],h=new Uint32Array(f),d=new Uint16Array(f);for(let g=0,y=f.byteLength/32;g<y;g++){let m=8*g,p=2*m;Xt(p,d)||(h[m+6]=h[m+6]/8-g)}}}}get primitiveStride(){return 3}get resolveTriangleIndex(){return this.resolvePrimitiveIndex}constructor(t,e={}){e.maxLeafTris&&(console.warn('MeshBVH: "maxLeafTris" option has been deprecated. Use "targetLeafSize", instead.'),e={...e,targetLeafSize:e.maxLeafTris}),super(t,e)}shiftTriangleOffsets(t){return super.shiftPrimitiveOffsets(t)}writePrimitiveBounds(t,e,n){let s=this.geometry,r=this._indirectBuffer,o=s.attributes.position,a=s.index?s.index.array:null,c=(r?r[t]:t)*3,u=c+0,f=c+1,h=c+2;a&&(u=a[u],f=a[f],h=a[h]);for(let d=0;d<3;d++){let g=o[pu[d]](u),y=o[pu[d]](f),m=o[pu[d]](h),p=g;y<p&&(p=y),m<p&&(p=m);let M=g;y>M&&(M=y),m>M&&(M=m),e[n+d]=p,e[n+d+3]=M}return e}computePrimitiveBounds(t,e,n){let s=this.geometry,r=this._indirectBuffer,o=s.attributes.position,a=s.index?s.index.array:null,l=o.normalized;if(t<0||e+t-n.offset>n.length/6)throw new Error("MeshBVH: compute triangle bounds range is invalid.");let c=o.array,u=o.offset||0,f=3;o.isInterleavedBufferAttribute&&(f=o.data.stride);let h=["getX","getY","getZ"],d=n.offset;for(let g=t,y=t+e;g<y;g++){let p=(r?r[g]:g)*3,M=(g-d)*6,b=p+0,x=p+1,S=p+2;a&&(b=a[b],x=a[x],S=a[S]),l||(b=b*f+u,x=x*f+u,S=S*f+u);for(let T=0;T<3;T++){let w,_,A;l?(w=o[h[T]](b),_=o[h[T]](x),A=o[h[T]](S)):(w=c[b+T],_=c[x+T],A=c[S+T]);let C=w;_<C&&(C=_),A<C&&(C=A);let P=w;_>P&&(P=_),A>P&&(P=A);let R=(P-C)/2,D=T*2;n[M+D+0]=C+R,n[M+D+1]=R+(Math.abs(C)+R)*js}}return n}raycastObject3D(t,e,n=[]){let{material:s}=t;if(s===void 0)return;gp.copy(t.matrixWorld).invert(),nc.copy(e.ray).applyMatrix4(gp),_p.setFromMatrixScale(t.matrixWorld),mp.copy(nc.direction).multiply(_p);let r=mp.length(),o=e.near/r,a=e.far/r;if(e.firstHitOnly===!0){let l=this.raycastFirst(nc,s,o,a);l=du(l,t,e),l&&n.push(l)}else{let l=this.raycast(nc,s,o,a);for(let c=0,u=l.length;c<u;c++){let f=du(l[c],t,e);f&&n.push(f)}}return n}refit(t=null){return(this.indirect?cp:tp)(this,t)}raycast(t,e=nn,n=0,s=1/0){let r=this._roots,o=[],a=this.indirect?hp:sp;for(let l=0,c=r.length;l<c;l++)a(this,l,e,t,o,n,s);return o}raycastFirst(t,e=nn,n=0,s=1/0){let r=this._roots,o=null,a=this.indirect?up:rp;for(let l=0,c=r.length;l<c;l++){let u=a(this,l,e,t,n,s);u!=null&&(o==null||u.distance<o.distance)&&(o=u)}return o}intersectsGeometry(t,e){let n=!1,s=this._roots,r=this.indirect?dp:ap;for(let o=0,a=s.length;o<a&&(n=r(this,o,t,e),!n);o++);return n}shapecast(t){let e=rn.getPrimitive(),n=super.shapecast({...t,intersectsPrimitive:t.intersectsTriangle,scratchPrimitive:e,iterate:this.indirect?ip:Qd});return rn.releasePrimitive(e),n}bvhcast(t,e,n){let{intersectsRanges:s,intersectsTriangles:r}=n,o=rn.getPrimitive(),a=this.geometry.index,l=this.geometry.attributes.position,c=this.indirect?g=>{let y=this.resolveTriangleIndex(g);ce(o,y*3,a,l)}:g=>{ce(o,g*3,a,l)},u=rn.getPrimitive(),f=t.geometry.index,h=t.geometry.attributes.position,d=t.indirect?g=>{let y=t.resolveTriangleIndex(g);ce(u,y*3,f,h)}:g=>{ce(u,g*3,f,h)};if(r){if(!(t instanceof i))throw new Error('MeshBVH: "intersectsTriangles" callback can only be used with another MeshBVH.');let g=(y,m,p,M,b,x,S,T)=>{for(let w=p,_=p+M;w<_;w++){d(w),u.a.applyMatrix4(e),u.b.applyMatrix4(e),u.c.applyMatrix4(e),u.needsUpdate=!0;for(let A=y,C=y+m;A<C;A++)if(c(A),o.needsUpdate=!0,r(o,u,A,w,b,x,S,T))return!0}return!1};if(s){let y=s;s=function(m,p,M,b,x,S,T,w){return y(m,p,M,b,x,S,T,w)?!0:g(m,p,M,b,x,S,T,w)}}else s=g}return super.bvhcast(t,e,{intersectsRanges:s})}intersectsBox(t,e){return ec.set(t.min,t.max,e),ec.needsUpdate=!0,this.shapecast({intersectsBounds:n=>ec.intersectsBox(n),intersectsTriangle:n=>ec.intersectsTriangle(n)})}intersectsSphere(t){return this.shapecast({intersectsBounds:e=>t.intersectsBox(e),intersectsTriangle:e=>e.intersectsSphere(t)})}closestPointToGeometry(t,e,n={},s={},r=0,o=1/0){return(this.indirect?pp:lp)(this,t,e,n,s,r,o)}closestPointToPoint(t,e={},n=0,s=1/0){return Xd(this,t,e,n,s)}};var Uw=parseInt("185")>=166,fr={Mesh:ve.prototype.raycast,Line:wi.prototype.raycast,LineSegments:ci.prototype.raycast,LineLoop:zs.prototype.raycast,Points:Vs.prototype.raycast,BatchedMesh:Dr.prototype.raycast},We=new ve,sc=[];function xp(i,t){if(this.isBatchedMesh)wv.call(this,i,t);else{let{geometry:e}=this;if(e.boundsTree)e.boundsTree.raycastObject3D(this,i,t);else{let n;if(this instanceof ve)n=fr.Mesh;else if(this instanceof ci)n=fr.LineSegments;else if(this instanceof zs)n=fr.LineLoop;else if(this instanceof wi)n=fr.Line;else if(this instanceof Vs)n=fr.Points;else throw new Error("BVH: Fallback raycast function not found.");n.call(this,i,t)}}}function wv(i,t){if(this.boundsTrees){let e=this.boundsTrees,n=this._drawInfo||this._instanceInfo,s=this._drawRanges||this._geometryInfo,r=this.matrixWorld;We.material=this.material,We.geometry=this.geometry;let o=We.geometry.boundsTree,a=We.geometry.drawRange;We.geometry.boundingSphere===null&&(We.geometry.boundingSphere=new ln);for(let l=0,c=n.length;l<c;l++){if(!this.getVisibleAt(l))continue;let u=n[l].geometryIndex;if(We.geometry.boundsTree=e[u],this.getMatrixAt(l,We.matrixWorld).premultiply(r),!We.geometry.boundsTree){this.getBoundingBoxAt(u,We.geometry.boundingBox),this.getBoundingSphereAt(u,We.geometry.boundingSphere);let f=s[u];We.geometry.setDrawRange(f.start,f.count)}We.raycast(i,sc);for(let f=0,h=sc.length;f<h;f++){let d=sc[f];d.object=this,d.batchId=l,t.push(d)}sc.length=0}We.geometry.boundsTree=o,We.geometry.drawRange=a,We.material=null,We.geometry=null}else fr.BatchedMesh.call(this,i,t)}function yp(i={}){let{type:t=ic}=i;return this.boundsTree=new t(this,i),this.boundsTree}function vp(){this.boundsTree=null}ve.prototype.raycast=xp;Te.prototype.computeBoundsTree=yp;Te.prototype.disposeBoundsTree=vp;var Ip=globalThis.__IFCLITE_VIEWER_CONFIG__,Cv="IFCVIEW1",Rv=["opaque_positions","opaque_normals","opaque_colors","opaque_indices","transparent_positions","transparent_normals","transparent_colors","transparent_indices"];if(!Ip)throw new Error("IFClite viewer configuration is missing.");var Wi=gi("ifcx-root"),Pv=gi("ifcx-canvas"),rc=gi("ifcx-status"),Qn=gi("ifcx-panel"),xu=gi("panel-content"),Pn=gi("ifcx-model-panel"),mr=gi("ifcx-model-search"),Iv=gi("ifcx-model-tree"),jn=gi("ifcx-context-menu"),j={metadata:null,batches:new Map,elementsById:new Map,rangesByBatch:new Map,customColors:new Map,hidden:new Set,selectedId:null,selectionReady:!1,modelOpenTypes:new Set,modelClosedGroups:new Set,modelFocusIds:null,modelFocusKey:null,gridVisible:!0,doubleSided:!0};Xi("Loading model\u2026");var ds=new Pr;ds.background=new Dt(16251130);var dn=new Je(45,1,.01,1e6);dn.up.set(0,0,1);var In=new Pl({canvas:Pv,antialias:!0,alpha:!1,logarithmicDepthBuffer:!0,powerPreference:"high-performance",preserveDrawingBuffer:!1});In.setPixelRatio(Math.min(globalThis.devicePixelRatio||1,1.75));In.outputColorSpace=en;In.toneMapping=Zr;In.toneMappingExposure=1.05;var fs=new Nl(dn,In.domElement);fs.enableDamping=!1;fs.screenSpacePanning=!0;fs.zoomToCursor=!0;fs.addEventListener("change",pn);ds.add(new kr(16777215,3884628,2.2));var Lp=new Hr(16777215,2.6);Lp.position.set(7,-10,14);ds.add(Lp);var yu=new Xn;yu.name="IFC model";ds.add(yu);var pr=new Xn;pr.name="IFC selection";ds.add(pr);var pi=null,mu=!1,dr=null,lc=new Wr;lc.firstHitOnly=!0;var gu=new Mt,Lv=new ResizeObserver(Hp);Lv.observe(Wi);for(let i of document.querySelectorAll("[data-action]"))i.addEventListener("click",()=>sM(i.dataset.action));for(let i of jn.querySelectorAll("[data-context-action]"))i.addEventListener("click",()=>iM(i.dataset.contextAction));var zn=null;for(let i of document.querySelectorAll(".panel-header"))i.addEventListener("pointerdown",oM),i.addEventListener("pointermove",aM),i.addEventListener("pointerup",Ep),i.addEventListener("pointercancel",Ep),i.addEventListener("dblclick",lM);mr.addEventListener("input",()=>So(mr.value));In.domElement.addEventListener("pointerdown",i=>{dr={x:i.clientX,y:i.clientY,button:i.button}});In.domElement.addEventListener("pointerup",i=>{if(!dr||dr.button!==0)return;let t=Math.hypot(i.clientX-dr.x,i.clientY-dr.y);dr=null,t<=5&&(j.modelFocusIds?gr():Np(i.clientX,i.clientY))});In.domElement.addEventListener("dblclick",()=>bu());In.domElement.addEventListener("contextmenu",nM);globalThis.addEventListener("pointerdown",i=>{!jn.hidden&&i.target instanceof Node&&!jn.contains(i.target)&&dc()});globalThis.addEventListener("blur",dc);globalThis.addEventListener("keydown",i=>{i.key==="Escape"&&dc()});Dv().catch(i=>{console.error(i),Xi(i instanceof Error?i.message:String(i),!0)});async function Dv(){let i=await Nv(Ip.payload);Xi("Unpacking model\u2026");let t=await Uv(i),e=Fv(t);j.metadata=e.metadata,Bv(e.metadata.elements||[]),So(),Mp("opaque",e.sections,!1),Mp("transparent",e.sections,!0),Kv(),fc(),Hp(),pn();let n=e.metadata.model||{},s=[...j.batches.values()].reduce((r,o)=>r+o.geometry.index.count/3,0);Xi(`${_u(n.element_count||j.elementsById.size)} elements \xB7 ${_u(s)} triangles`),globalThis.IFCViewer=rM(),globalThis.dispatchEvent(new CustomEvent("ifcviewer:ready",{detail:{model:e.metadata.model}})),await Gv()}async function Nv(i){if(!i||!i.mode)throw new Error("Viewer payload configuration is invalid.");if(i.mode==="inline"){let t=document.getElementById(i.elementId);if(!t)throw new Error("Embedded model payload was not found.");return hM(t.textContent.trim())}if(i.mode==="url"){let t=await fetch(i.url,{cache:"force-cache"});if(!t.ok)throw new Error(`Model download failed with HTTP ${t.status}.`);return new Uint8Array(await t.arrayBuffer())}throw new Error(`Unsupported payload mode: ${i.mode}`)}async function Uv(i){if(typeof DecompressionStream!="function")throw new Error("This browser does not support gzip decompression streams.");let t=new Blob([i]).stream().pipeThrough(new DecompressionStream("gzip"));return new Response(t).arrayBuffer()}function Fv(i){let t=new Uint8Array(i);if(new TextDecoder().decode(t.subarray(0,8))!==Cv)throw new Error("The model payload has an unknown format.");let n=new DataView(i),s=8,r=n.getUint32(s,!0);s+=4;let o=t.subarray(s,s+r),a=JSON.parse(new TextDecoder().decode(o));s=Rp(s+r);let l={};for(let u of Rv){let f=n.getUint32(s,!0);s+=4,l[u]={offset:s,length:f},s=Rp(s+f)}let c={opaque_positions:ac(i,l.opaque_positions),opaque_normals:ac(i,l.opaque_normals),opaque_colors:Cp(i,l.opaque_colors),opaque_indices:wp(i,l.opaque_indices),transparent_positions:ac(i,l.transparent_positions),transparent_normals:ac(i,l.transparent_normals),transparent_colors:Cp(i,l.transparent_colors),transparent_indices:wp(i,l.transparent_indices)};return{metadata:a,sections:c}}function Mp(i,t,e){let n=t[`${i}_positions`],s=t[`${i}_normals`],r=t[`${i}_colors`],o=t[`${i}_indices`];if(!n.length||!o.length)return;let a=new Te;a.setAttribute("position",new fe(n,3)),a.setAttribute("normal",new fe(s,3)),a.setAttribute("color",new fe(r,4,!0)),a.setIndex(new fe(o,1)),a.computeBoundingBox(),a.computeBoundingSphere();let l=new Or({vertexColors:!0,roughness:.78,metalness:.02,side:j.doubleSided?Ke:nn,transparent:e,depthWrite:!e,alphaHash:!1,alphaTest:.01});l.forceSinglePass=e;let c=new ve(a,l);c.name=`${i} IFC geometry`,c.userData.batchName=i,yu.add(c),j.batches.set(i,{mesh:c,geometry:a,material:l,transparent:e})}function Bv(i){let t=new Map;for(let e of i){let n=Number(e.id);e.id=n,j.elementsById.set(n,e),t.has(e.batch)||t.set(e.batch,[]),t.get(e.batch).push(e),Array.isArray(e.configured_color)?j.customColors.set(n,e.configured_color.slice()):Array.isArray(e.base_color)&&j.customColors.set(n,e.base_color.slice()),Array.isArray(e.display_color)&&(e.display_color[3]??255)===0&&j.hidden.add(n)}for(let[e,n]of t)n.sort((s,r)=>s.triangle_start-r.triangle_start),j.rangesByBatch.set(e,n)}function So(i=""){let t=String(i).trim().toLocaleLowerCase(),e=new Map;for(let s of j.elementsById.values()){let r=`${s.ifc_type||""} ${s.name||""} ${s.id}`.toLocaleLowerCase();if(t&&!r.includes(t))continue;let o=s.ifc_type||"IfcProduct";e.has(o)||e.set(o,[]),e.get(o).push(s)}let n=document.createDocumentFragment();for(let[s,r]of[...e].sort(([o],[a])=>o.localeCompare(a)))n.append(Ov({groupKey:`type:${s}`,label:`${mi(s)} (${r.length})`,focusLabel:mi(s),elements:r,depth:0,defaultOpen:!!t}));n.childNodes.length||n.append(Re("p","model-tree-empty","No elements found.")),Iv.replaceChildren(n)}function Ov({groupKey:i,label:t,focusLabel:e,elements:n,depth:s,defaultOpen:r=!1}){let o=document.createElement("details");o.className="model-group element-type-group",o.open=Vv(i,r),o.classList.toggle("focused",j.modelFocusKey===i);let a=document.createElement("summary");a.style.setProperty("--tree-depth",String(s)),a.append(Re("span","model-group-label",t),Dp(n,i,e)),o.append(a);let l=Re("div","model-group-items"),c=()=>{if(!l.childElementCount)for(let u of n)l.append(kv(u,s+1))};return zv({details:o,summary:a,populate:c,groupKey:i,elements:n}),o.open&&c(),o.append(l),o}function zv({details:i,summary:t,populate:e,groupKey:n,elements:s}){t.addEventListener("click",r=>{r.target.closest(".visibility-button")||(r.preventDefault(),i.open=!i.open,Sp(n,i.open),i.open&&e(),vu(s,n))}),i.addEventListener("toggle",()=>{Sp(n,i.open),i.open&&e()})}function Vv(i,t=!1){return j.modelClosedGroups.has(i)?!1:j.modelOpenTypes.has(i)||t}function Sp(i,t){t?(j.modelOpenTypes.add(i),j.modelClosedGroups.delete(i)):(j.modelOpenTypes.delete(i),j.modelClosedGroups.add(i))}function kv(i,t=1){let e=Re("div","model-element");e.style.setProperty("--tree-depth",String(t));let n=`element:${i.id}`;j.modelFocusKey===n&&e.classList.add("selected"),j.hidden.has(i.id)&&e.classList.add("hidden");let s=Re("button","model-element-select",i.name||`${mi(i.ifc_type)} #${i.id}`);return s.type="button",s.title=s.textContent,s.addEventListener("click",()=>{vu([i],n)}),e.append(s,Dp([i],n,s.textContent)),e}function Dp(i,t,e){let n=Re("button","visibility-button");n.type="button";let s=j.modelFocusKey===t;return n.classList.toggle("active",s),n.setAttribute("aria-pressed",String(s)),n.setAttribute("aria-label",s?`Show all model after ${e}`:`Focus ${e}`),n.innerHTML='<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 12s3.5-6 9-6 9 6 9 6-3.5 6-9 6-9-6-9-6Z"/><circle cx="12" cy="12" r="2.5"/></svg>',n.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),vu(i,t)}),n}function vu(i,t){if(j.modelFocusKey===t){gr();return}j.hidden.clear(),j.modelFocusIds=new Set(i.map(e=>e.id)),j.modelFocusKey=t,Op(!0),j.selectedId=null,zp(),xu.replaceChildren(Re("p","panel-empty","Click an element in the model to inspect it.")),uc(),So(mr.value),pn()}function mi(i){return String(i||"IfcProduct").replace(/^Ifc/,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2")}async function Gv(){if(j.batches.size){Xi("Building fast selection index\u2026"),await Pp();try{for(let{geometry:t}of j.batches.values())t.computeBoundsTree({strategy:0,indirect:!0,targetLeafSize:24}),await Pp();j.selectionReady=!0;let i=j.metadata.model||{};Xi(`${_u(i.element_count||j.elementsById.size)} elements \xB7 ready`)}catch(i){console.warn("BVH construction failed; falling back to standard raycasting.",i),j.selectionReady=!0,Xi("Model ready; fast selection index could not be built.",!0)}}}function Np(i,t){if(!j.selectionReady)return Xi("Selection index is still being built."),null;let e=In.domElement.getBoundingClientRect();gu.x=(i-e.left)/e.width*2-1,gu.y=-((t-e.top)/e.height)*2+1,lc.setFromCamera(gu,dn),lc.firstHitOnly=j.hidden.size===0;let n=lc.intersectObjects([...j.batches.values()].map(s=>s.mesh),!1);for(let s of n){let r=s.object.userData.batchName,o=Hv(r,s.faceIndex);if(o&&!j.hidden.has(o.id))return hc(o.id),o}return hc(null),null}function Hv(i,t){if(!Number.isInteger(t))return null;let e=j.rangesByBatch.get(i)||[],n=0,s=e.length-1;for(;n<=s;){let r=n+s>>1,o=e[r],a=o.triangle_start,l=a+o.triangle_count;if(t<a)s=r-1;else if(t>=l)n=r+1;else return o}return null}function hc(i,t=!0){let e=i==null?null:Number(i);if(e!==null&&!j.elementsById.has(e))return!1;let n=j.selectedId;if(j.selectedId=e,_r([n,e].filter(s=>s!==null)),zp(),e===null)xu.replaceChildren(Re("p","panel-empty","Click an element in the model to inspect it.")),globalThis.dispatchEvent(new CustomEvent("ifcviewer:select",{detail:null}));else{let s=j.elementsById.get(e);Mu(s),t&&(Mo(Pn),Pn.classList.remove("open"),Pn.setAttribute("aria-hidden","true"),ti("toggle-model",!1),Qn.classList.add("open"),Qn.setAttribute("aria-hidden","false"),ti("toggle-panel",!0)),globalThis.dispatchEvent(new CustomEvent("ifcviewer:select",{detail:s}))}return bo(),pn(),!0}function Mu(i){let t=document.createDocumentFragment(),e=Re("section","property-card");e.append(Re("h2",null,"Attributes"));let n=Re("dl","identity-grid");Hi(n,"Name",i.name),Hi(n,"IFC class",mi(i.ifc_type)),Hi(n,"STEP ID",`#${i.id}`),Hi(n,"Global ID",i.global_id),Hi(n,"ObjectType",i.object_type);for(let s of i.attributes||[])Hi(n,s.name,Tu(s.value));e.append(n),t.append(e),Wv(t,i),bp(t,"Property sets",i.property_sets,"properties"),bp(t,"Quantity sets",i.quantity_sets,"quantities"),!i.attributes?.length&&!i.property_sets?.length&&!i.quantity_sets?.length&&t.append(Re("p","panel-empty","No decoded properties are available for this element.")),xu.replaceChildren(t)}function Wv(i,t){let e=j.metadata?.references||{},n=e.elements?.[String(t.id)];if(!n)return;let s=document.createElement("details");s.className="property-group reference-group",s.open=!0,s.append(Re("summary",null,"References"));let r=[];n.container_id!==void 0&&r.push(["Container",cc(n.container_id)]),n.storey_id!==void 0&&Number(n.storey_id)!==Number(n.container_id)&&r.push(["Storey",cc(n.storey_id)]),Array.isArray(n.referenced_by_structure)&&r.push(["Referenced by",n.referenced_by_structure.map(cc).filter(Boolean).join(", ")]),vo(s,"Spatial",r);let o=Xv(n.relationships||[]);vo(s,"Relationships",o);for(let a of n.materials||[]){let l=e.material_definitions?.[String(a.definition_id)]||{},c=l.name&&l.name!=="<Unnamed>"?l.name:"Unnamed material";vo(s,"Material",[["Name",c],["Category",l.category]]),vo(s,"Definition",[["Type",mi(l.material_type)],["Inherited from type",a.inherited_from_type==null?null:Up(a.inherited_from_type)]]),oc(s,"Layers",l.layers),oc(s,"Constituents",l.constituents),oc(s,"Profiles",l.profiles),oc(s,"Materials",l.materials)}s.children.length>1&&i.append(s)}function vo(i,t,e){let n=e.filter(([,o])=>o!=null&&o!=="");if(!n.length)return;let s=document.createElement("details");s.className="property-set reference-set",s.open=!0,s.append(Re("summary",null,t));let r=Re("dl","property-list");for(let[o,a]of n)Hi(r,o,a);s.append(r),i.append(s)}function cc(i){let t=Number(i),e=j.metadata?.references?.spatial_nodes?.[String(t)];if(!e)return null;let n=mi(e.ifc_type);return e.name&&!/^Entity #\d+$/i.test(e.name)?e.name:n}function Xv(i){let t=new Map;for(let e of i){let n=qv(e);t.has(n)||t.set(n,[]),t.get(n).push(e)}return[...t.entries()].map(([e,n])=>{let s=n.map(a=>Up(a.target_id)).filter(Boolean);if(!s.length)return null;let r=s.slice(0,4).join(", "),o=s.length>4?` +${s.length-4} more`:"";return[e,`${r}${o}`]}).filter(Boolean)}function qv(i){let t=i.role==="related";switch(i.relationship_type){case"IfcRelDefinesByType":return t?"Type definition":"Typed occurrences";case"IfcRelAggregates":return t?"Aggregated by":"Aggregated parts";case"IfcRelNests":return t?"Nested under":"Nested items";default:return`${mi(i.relationship_type)} ${t?"from":"to"}`}}function Up(i){let t=Number(i),e=j.elementsById.get(t);if(e)return e.name||mi(e.ifc_type);if(j.metadata?.references?.spatial_nodes?.[String(t)])return cc(t);let s=j.metadata?.references?.referenced_entities?.[String(t)];return s?s.name||s.object_type||mi(s.ifc_type):null}function Yv(i){let t=i.material_name||i.name||i.profile_name||"Unnamed",e=i.material_category||i.category,n=Number(i.thickness),s=[];return e&&s.push(e),Number.isFinite(n)&&s.push(Tu(n)),s.length?`${t} (${s.join(" \xB7 ")})`:t}function oc(i,t,e){if(!Array.isArray(e)||!e.length)return;let n=e.map((s,r)=>[e.length===1?"Name":`Item ${r+1}`,Yv(s)]);vo(i,t,n)}function bp(i,t,e,n){if(!Array.isArray(e)||e.length===0)return;let s=document.createElement("details");s.className="property-group",s.open=!0,s.append(Re("summary",null,t));for(let r of e){let o=document.createElement("details");o.className="property-set",o.open=!0,o.append(Re("summary",null,r.name||"Unnamed set"));let a=Re("dl","property-list");for(let l of r[n]||[])Hi(a,l.name,Tu(l.value));o.append(a),s.append(o)}i.append(s)}function Hi(i,t,e){e==null||e===""||(i.append(Re("dt",null,String(t||"Value"))),i.append(Re("dd",null,String(e))))}function Tp(i,t){let e=To(i),n=uM(t);for(let s of e)j.elementsById.has(s)&&j.customColors.set(s,n.slice());_r(e),j.selectedId!==null&&e.includes(j.selectedId)&&Mu(j.elementsById.get(j.selectedId)),pn()}function Zv(i){let t=To(i);for(let e of t){let n=j.elementsById.get(e);n&&j.customColors.set(e,n.base_color.slice())}_r(t),j.selectedId!==null&&t.includes(j.selectedId)&&Mu(j.elementsById.get(j.selectedId)),pn()}function Fp(i){let t=!!j.modelFocusIds;Su();let e=To(i);e.forEach(s=>j.hidden.add(s)),j.selectedId!==null&&e.includes(j.selectedId)?hc(null):t?uc():_r(e),bo(),pn()}function $v(i){let t=To(i);t.forEach(e=>j.hidden.delete(e)),_r(t),bo(),pn()}function Bp(i){Su();let t=new Set(To(i));j.hidden.clear();for(let e of j.elementsById.keys())t.has(e)||j.hidden.add(e);uc(),bo(),pn()}function gr(){Su(),j.hidden.clear(),uc(),bo(),pn()}function Su(){j.modelFocusIds&&Op(!1),j.modelFocusIds=null,j.modelFocusKey=null}function Op(i){for(let t of j.batches.values())t.material.transparent=i||t.transparent,t.material.alphaHash=!1,t.material.depthWrite=!t.transparent,t.material.needsUpdate=!0}function bo(){Pn.classList.contains("open")&&So(mr.value)}function Jv(i){let t=(j.customColors.get(i.id)||i.base_color||[184,188,199,255]).slice();return j.hidden.has(i.id)?t[3]=0:j.modelFocusIds&&(j.modelFocusIds.has(i.id)?(t[0]=255,t[1]=184,t[2]=0,t[3]=255):t[3]=Math.min(t[3],24)),t}function zp(){for(let d of[...pr.children])pr.remove(d),d.geometry?.dispose(),d.material?.dispose();if(j.selectedId===null)return;let i=j.elementsById.get(j.selectedId),t=i&&j.batches.get(i.batch);if(!i||!t)return;let e=t.geometry.getAttribute("position").array,n=t.geometry.index.array,s=i.vertex_start,r=s+i.vertex_count,o=i.triangle_start*3,a=o+i.triangle_count*3,l=e.slice(s*3,r*3),c=n.slice(o,a);for(let d=0;d<c.length;d+=1)c[d]-=s;let u=new Te;u.setAttribute("position",new fe(l,3)),u.setIndex(new fe(c,1));let f=new ve(u,new ss({color:16765774,transparent:!0,opacity:.16,depthWrite:!1,side:Ke,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1}));f.renderOrder=10,pr.add(f);let h=new ci(new Fr(u,35),new rs({color:16758528,depthTest:!0,depthWrite:!1,linewidth:2,toneMapped:!1}));h.renderOrder=11,pr.add(h)}function uc(){_r([...j.elementsById.keys()])}function _r(i){let t=new Map;for(let e of new Set(i.map(Number))){let n=j.elementsById.get(e);if(!n)continue;let s=j.batches.get(n.batch);if(!s)continue;let o=s.geometry.getAttribute("color").array,a=Jv(n),l=n.vertex_start*4,c=l+n.vertex_count*4;for(let f=l;f<c;f+=4)o[f]=a[0],o[f+1]=a[1],o[f+2]=a[2],o[f+3]=a[3];let u=t.get(n.batch)||{start:l,end:c};u.start=Math.min(u.start,l),u.end=Math.max(u.end,c),t.set(n.batch,u)}for(let[e,n]of t){let s=j.batches.get(e).geometry.getAttribute("color");s.clearUpdateRanges?.(),s.addUpdateRange?.(n.start,n.end-n.start),s.needsUpdate=!0}}function fc(){let i=j.metadata?.model?.local_bbox;!Array.isArray(i)||i.length!==6||Vp(new Jt(new L(i[0],i[1],i[2]),new L(i[3],i[4],i[5])))}function bu(){if(j.selectedId===null){fc();return}let i=j.elementsById.get(j.selectedId);!i?.bbox||i.bbox.length!==6||Vp(new Jt(new L(i.bbox[0],i.bbox[1],i.bbox[2]),new L(i.bbox[3],i.bbox[4],i.bbox[5])),1.8)}function Vp(i,t=1.35){if(i.isEmpty())return;let e=i.getSize(new L),n=i.getCenter(new L),s=Math.max(e.length()*.5,.1),r=so.degToRad(dn.fov),o=s/Math.sin(r*.5)*t,a=new L(1,-1.25,.85).normalize();dn.position.copy(n).addScaledVector(a,o),fs.target.copy(n),fs.update(),Wp(),pn()}function Kv(){let i=j.metadata?.model?.local_bbox;if(!Array.isArray(i)||i.length!==6)return;let t=Math.max(i[3]-i[0],i[4]-i[1],1),e=dM(t*1.5);pi=new Xr(e,40,6122363,3160390),pi.rotation.x=Math.PI/2,pi.position.set((i[0]+i[3])/2,(i[1]+i[4])/2,i[2]-e*.001),pi.material.transparent=!0,pi.material.opacity=.28,pi.material.depthWrite=!1,ds.add(pi)}function jv(){j.gridVisible=!j.gridVisible,pi&&(pi.visible=j.gridVisible),ti("toggle-grid",j.gridVisible),pn()}function kp(i){j.doubleSided=!!i;for(let{material:t}of j.batches.values())t.side=j.doubleSided?Ke:nn,t.needsUpdate=!0;ti("toggle-double-side",j.doubleSided),pn()}function Qv(){kp(!j.doubleSided)}function tM(){let i=Qn.classList.toggle("open");i||Mo(Qn),Qn.setAttribute("aria-hidden",String(!i)),i&&(Mo(Pn),Pn.classList.remove("open"),Pn.setAttribute("aria-hidden","true"),ti("toggle-model",!1)),ti("toggle-panel",i)}function eM(){let i=Pn.classList.toggle("open");i||Mo(Pn),Pn.setAttribute("aria-hidden",String(!i)),i?(Mo(Qn),Qn.classList.remove("open"),Qn.setAttribute("aria-hidden","true"),ti("toggle-panel",!1),So(mr.value),mr.focus()):gr(),ti("toggle-model",i)}function Mo(i){let t=document.activeElement;t instanceof HTMLElement&&i.contains(t)&&t.blur()}function nM(i){i.preventDefault();let t=Np(i.clientX,i.clientY);for(let l of jn.querySelectorAll("[data-context-action]"))l.disabled=!t&&l.dataset.contextAction!=="show-all";jn.hidden=!1;let e=Wi.getBoundingClientRect(),n=8,s=i.clientX-e.left,r=i.clientY-e.top,o=Wi.clientWidth-jn.offsetWidth-n,a=Wi.clientHeight-jn.offsetHeight-n;jn.style.left=`${Math.max(n,Math.min(o,s))}px`,jn.style.top=`${Math.max(n,Math.min(a,r))}px`}function dc(){jn.hidden=!0}function iM(i){let t=j.selectedId;switch(dc(),i){case"show-properties":t!==null&&(Pn.classList.remove("open"),Pn.setAttribute("aria-hidden","true"),ti("toggle-model",!1),Qn.classList.add("open"),Qn.setAttribute("aria-hidden","false"),ti("toggle-panel",!0));break;case"isolate":t!==null&&Bp(t);break;case"hide-selected":t!==null&&Fp(t);break;case"show-all":gr();break;default:break}}function ti(i,t){document.querySelector(`[data-action="${i}"]`)?.setAttribute("aria-pressed",String(t))}function sM(i){switch(i){case"fit":fc();break;case"fit-selection":bu();break;case"toggle-grid":jv();break;case"show-all":gr();break;case"toggle-panel":tM();break;case"toggle-model":eM();break;case"toggle-double-side":Qv();break;default:break}}function rM(){let i=(e={})=>{typeof e=="string"&&(e={text:e});let n=e.ifcType?new Set((Array.isArray(e.ifcType)?e.ifcType:[e.ifcType]).map(a=>String(a).toLocaleLowerCase())):null,s=String(e.text||"").trim().toLocaleLowerCase(),r=!!e.visibleOnly,o=[];for(let a of j.elementsById.values())n&&!n.has(String(a.ifc_type||"").toLocaleLowerCase())||r&&j.hidden.has(a.id)||s&&![a.id,a.ifc_type,a.name,a.global_id,a.object_type,a.description].filter(c=>c!=null).join(" ").toLocaleLowerCase().includes(s)||o.push(a.id);return o};return Object.freeze({select:hc,setColor:Tp,setColorByType:(e,n)=>{let s=i({ifcType:e});return Tp(s,n),s},resetColor:Zv,hide:Fp,show:$v,isolate:Bp,showAll:gr,fit:fc,fitSelection:bu,setDoubleSided:kp,getSelected:()=>j.selectedId,getElement:e=>j.elementsById.get(Number(e))||null,getReferences:e=>structuredClone(j.metadata?.references?.elements?.[String(Number(e))]||null),find:i,getModelInfo:()=>structuredClone(j.metadata.model),getElementIds:()=>[...j.elementsById.keys()]})}function oM(i){if(i.button!==0||i.target.closest("button")||matchMedia("(max-width: 720px)").matches)return;let t=i.currentTarget.closest(".viewer-panel"),e=t.getBoundingClientRect();t.style.left=`${e.left}px`,t.style.top=`${e.top}px`,t.style.right="auto",t.style.bottom="auto",zn={panel:t,header:i.currentTarget,pointerId:i.pointerId,offsetX:i.clientX-e.left,offsetY:i.clientY-e.top},zn.header.setPointerCapture(i.pointerId),t.classList.add("dragging"),i.preventDefault()}function aM(i){!zn||i.pointerId!==zn.pointerId||Gp(zn.panel,i.clientX-zn.offsetX,i.clientY-zn.offsetY)}function Ep(i){if(!zn||i.pointerId!==zn.pointerId)return;let{panel:t,header:e,pointerId:n}=zn;zn=null,t.classList.remove("dragging"),e.hasPointerCapture(n)&&e.releasePointerCapture(n)}function Gp(i,t,e){let s=Math.max(10,Wi.clientWidth-i.offsetWidth-10),r=Math.max(10,Wi.clientHeight-i.offsetHeight-10);i.style.left=`${Math.min(s,Math.max(10,t))}px`,i.style.top=`${Math.min(r,Math.max(10,e))}px`}function lM(i){if(matchMedia("(max-width: 720px)").matches)return;let t=i.currentTarget.closest(".viewer-panel");t.style.removeProperty("left"),t.style.removeProperty("top"),t.style.removeProperty("right"),t.style.removeProperty("bottom")}function cM(){if(!matchMedia("(max-width: 720px)").matches)for(let i of document.querySelectorAll(".viewer-panel"))i.style.left&&Gp(i,Number.parseFloat(i.style.left),Number.parseFloat(i.style.top))}function Hp(){let i=Math.max(Wi.clientWidth,1),t=Math.max(Wi.clientHeight,1);In.setSize(i,t,!1),dn.aspect=i/t,dn.updateProjectionMatrix(),cM(),pn()}function pn(){mu||(mu=!0,requestAnimationFrame(()=>{mu=!1,Wp(),In.render(ds,dn)}))}function Wp(){let i=j.metadata?.model?.local_bbox;if(!Array.isArray(i)||i.length!==6)return;let t=Math.max(i[3]-i[0],i[4]-i[1],i[5]-i[2],1),e=Math.max(dn.position.distanceTo(fs.target),.01),n=Math.max(e/500,t/1e6,.001),s=Math.max(e+t*4,n*100);Math.abs(dn.near-n)<n*.01&&Math.abs(dn.far-s)<s*.01||(dn.near=n,dn.far=s,dn.updateProjectionMatrix())}var Ap;function Xi(i,t=!1){rc.textContent=i,rc.classList.toggle("warning",t),rc.classList.add("visible"),clearTimeout(Ap),Ap=setTimeout(()=>rc.classList.remove("visible"),t?8e3:3500)}function hM(i){let e=i.endsWith("==")?2:i.endsWith("=")?1:0,n=new Uint8Array(i.length*3/4-e),s=0;for(let r=0;r<i.length;r+=32768){let o=atob(i.slice(r,r+32768));for(let a=0;a<o.length;a+=1)n[s++]=o.charCodeAt(a)}return n}function uM(i){if(Array.isArray(i)||ArrayBuffer.isView(i)){let n=Array.from(i).slice(0,4).map(Number);if(n.length!==3&&n.length!==4)throw new Error("A color array must contain three or four channels.");if(!n.every(Number.isFinite))throw new Error("Color channels must be finite numbers.");let s=n.slice(0,3).every(o=>o>=0&&o<=1),r=n.length===4&&n[3]>=0&&n[3]<=1;for(let o=0;o<3;o+=1)s&&(n[o]*=255);return n.length===3?n.push(255):r&&(n[3]*=255),n.map(o=>Math.max(0,Math.min(255,Math.round(o))))}let t=String(i).trim();if(/^#[0-9a-f]{3,8}$/i.test(t)){let n=t.slice(1);if((n.length===3||n.length===4)&&(n=[...n].map(s=>s+s).join("")),n.length===6&&(n+="ff"),n.length===8)return[0,2,4,6].map(s=>parseInt(n.slice(s,s+2),16))}let e=new Dt(t);return[Math.round(e.r*255),Math.round(e.g*255),Math.round(e.b*255),255]}function To(i){return i==null?[]:typeof i=="number"||typeof i=="string"?[Number(i)]:[...i].map(Number).filter(Number.isFinite)}function gi(i){let t=document.getElementById(i);if(!t)throw new Error(`Missing viewer element #${i}.`);return t}function Re(i,t,e){let n=document.createElement(i);return t&&(n.className=t),e!=null&&(n.textContent=String(e)),n}function Tu(i){return i==null?"\u2014":typeof i=="number"?fM(i):String(i)}function fM(i){return new Intl.NumberFormat(void 0,{maximumFractionDigits:6}).format(i)}function _u(i){return new Intl.NumberFormat(void 0,{maximumFractionDigits:0}).format(Number(i)||0)}function dM(i){let t=Math.floor(Math.log10(i)),e=i/10**t;return(e<=1?1:e<=2?2:e<=5?5:10)*10**t}function ac(i,t){return t.length?new Float32Array(i,t.offset,t.length/4):new Float32Array}function wp(i,t){return t.length?new Uint32Array(i,t.offset,t.length/4):new Uint32Array}function Cp(i,t){return t.length?new Uint8Array(i,t.offset,t.length):new Uint8Array}function Rp(i){return i+3&-4}function Pp(){return new Promise(i=>requestAnimationFrame(i))}
